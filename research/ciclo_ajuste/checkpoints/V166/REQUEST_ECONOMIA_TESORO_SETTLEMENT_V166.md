# Solicitud al Ministerio de Economía / Tesoro · V166
...
- tabla de cuatro rondas: `E0_FISCAL_PUBLIC_BUYBACK_CALLS_2008_V166.csv`;
- resumen del strip: `E0_FISCAL_STRIP_BUYBACK_SUMMARY_2009_V166.csv`;
- cadena normativa: `E0_FISCAL_BUYBACK_SETTLEMENT_CHAIN_V166.csv`.
- matriz de comunicaciones directas: `E0_CAJA_TARGET_COMMUNICATION_MATRIX_V166.csv`;
- hoja de claves técnicas: sólo las filas `REQ133_ECON` de `E0_REQUEST_SEARCH_KEY_MATRIX_V166.csv`.



- puente contable trimestral: `E0_FISCAL_BUYBACK_DEBT_ACCOUNTING_BRIDGE_2008_V166.csv`.

## Clave adicional V166 · Discount en Pesos
...
## Clave V166 · expediente productor y submayores SIGADE/SIDIF
...
## Clave V166 · productor, sistemas y formato de salida demostrados
...
## Clave V166 · ruta COMDOC y comparadores contiguos
...
## Clave V166 · salida FindDoc y cadena C-41
...
## Clave V166 · AGAN/AMIDDF, sistema productor y pago parcial
...
## Clave V166 · productor exacto, índice AMIDDF y bifurcación de comisiones
...
## Clave V166 · exportación SICHE y test condicional C-55 por débito directo
...
## Clave V166 · capacidad SICHE demostrada y doble prioridad C-41/C-55
...
## Clave V166 · consultas SICHE nombradas y runbook exacto
...
## Clave V166 · repositorio histórico CUT 2007-2014
...
## Clave V166 · cuenta 230, códigos automáticos y conciliación
...
## Clave contemporánea V166 · SLU 2001-2005 y prueba de rama
...
## Clave V166 · tablas exactas, ausencia de historia y recuperación forense
...
## Clave V166 · SICHE, retención perpetua y migración
...
## Rectificación y ampliación V166 · Anexo K, mayorizado y respaldo bancario
...
## Rectificación V166 · excepción SAF 355 y ruta TGN/CGN/BNA
...
## Ampliación V166 · cierre 2008, archivo oficial y custodios nominados
...
## Ampliación V166 · universo C-41/C-42/C-55 y cadena completa
...
## Ampliación V166 · doble repositorio SIDIF, TRANSAF y certificación UAI
...
## V166 · objetos exactos de certificación y cierre
...
## V166 · notas exactas, SISIO y registro interno pre-GDE
...
## V166 · deber exacto del período, SISIO y papeles UAI
