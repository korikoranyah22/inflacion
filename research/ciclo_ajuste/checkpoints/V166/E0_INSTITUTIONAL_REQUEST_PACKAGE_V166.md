...
- Economía / Tesoro: `REQUEST_ECONOMIA_TESORO_SETTLEMENT_V166.md`
- BCRA / CRyL: `REQUEST_BCRA_CRYL_SETTLEMENT_V166.md`
- Banco Nación: `REQUEST_BNA_FIRST_STAGE_BLOTTER_V166.md`
- AGN: `REQUEST_AGN_2018_REPLY_V166.md`
- CNV: `REQUEST_CNV_CUSTODY_RECORDS_V166.md`
- Caja de Valores: `REQUEST_CAJA_SETTLEMENT_HOLDINGS_V166.md`

## Adjuntos mínimos

- `E0_CAJA_TARGET_COMMUNICATION_MATRIX_V166.csv`
- `E0_INFORMATION_REQUEST_TRACEABILITY_V166.csv`
- `E0_REQUEST_SEARCH_KEY_MATRIX_V166.csv`
- `E0_REQUEST_ATTACHMENT_MINIMUM_V166.csv`
- `E0_REQUEST_CLOSURE_CRITERIA_V166.csv`
- `E0_CAJA_CRYL_SETTLEMENT_STAGE_MATRIX_V166.csv`
- `E0_DEFERRED_MODALITY_EQUIVALENCE_AUDIT_V166.csv`
...
## Clave V166 · GDP Units y cancelación contractual
...
## Clave V166 · tablas SLU y recuperación histórica

El pedido Economía/Tesoro incorpora las doce tablas exactas de cuenta, movimiento, aplicación automática y Libro Banco; incluye activas, bajas y rehabilitadas, backups/snapshots 2006-2009, versión y migración v7→v9.0, historial de correcciones, C10 de recurso y C55/cheque como controles. Adjuntos específicos: `E0_SLU_BASE_TABLE_DICTIONARY_V166.csv`, `E0_SLU_HISTORICAL_RECOVERY_STRATEGY_V166.csv`, `E0_SLU_AUTOMATIC_EXPENSE_MAPPING_CHAIN_V166.csv` y `E0_SLU_TABLE_REQUEST_FIELD_MATRIX_V166.csv`. Estado: `DRAFT_NOT_SENT`.

## Clave V166 · obligación de resguardo y consulta SICHE

El pedido Economía/Tesoro nombra inventario SICHE, planillas, logs, actas de recuperación, Acta Acuerdo, backup previo, migración, comparación entre bases e informes firmados. Adjuntos: `E0_SLU_BACKUP_RETENTION_DUTY_V166.csv`, `E0_SLU_MIGRATION_DOCUMENT_CHAIN_V166.csv`, `E0_SLU_BACKUP_AND_SICHE_REQUEST_OBJECTS_V166.csv` y `E0_SICHE_SLU_LEGAL_CUSTODY_EXPORT_ROUTE_V166.csv`. Estado: `DRAFT_NOT_SENT`.

## Clave V166 · ruta primaria SAF 355

El pedido Economía/Tesoro se reorienta a `SIGADE → SIDIF-Link → SIDIF Central → SICHE`, con CUT/extracto para probar liquidación. La pista REPO 2019 se mantiene como comparador, con diferencia interna publicada de $0,45 millones. SLU queda condicional. Adjuntos: `E0_SAF355_SIGADE_SIDIF_LINK_SYSTEM_CHAIN_V166.csv`, `E0_SICHE_SIDIF_CENTRAL_TARGET_ROUTE_V166.csv`, `E0_SIDIF_LINK_SICHE_REQUEST_OBJECTS_V166.csv` y `E0_REPO_COMMISSION_ACCOUNT_LEAD_V166.csv`. Estado: `DRAFT_NOT_SENT`.

## Ampliación V166 · prueba cruzada oficial
