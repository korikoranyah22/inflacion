# Solicitud a la Auditoría General de la Nación · V166
...
Como hoja identificadora puede adjuntarse `E0_AGN_BODEN_REQUEST_PUBLIC_SCHEMA_V166.csv`, que contiene sólo UUID, nid, vid, fechas y metadatos públicos; no incluye datos personales del solicitante original.
...
## Clave V166 · proyecto 48 0237/09 y actuación final
...
## Clave V166 · identidad final cerrada y anexos trimestrales faltantes
...
## Clave V166 · remisión parlamentaria y archivo
...
## Clave V166 · inventario público y nota de archivo
