# Solicitud al Ministerio de Economía / Tesoro · V130
...
- tabla de cuatro rondas: `E0_FISCAL_PUBLIC_BUYBACK_CALLS_2008_V130.csv`;
- resumen del strip: `E0_FISCAL_STRIP_BUYBACK_SUMMARY_2009_V130.csv`;
- cadena normativa: `E0_FISCAL_BUYBACK_SETTLEMENT_CHAIN_V130.csv`.
- matriz de comunicaciones directas: `E0_CAJA_TARGET_COMMUNICATION_MATRIX_V130.csv`;
- hoja de claves técnicas: sólo las filas `REQ130_ECON` de `E0_REQUEST_SEARCH_KEY_MATRIX_V130.csv`.



- puente contable trimestral: `E0_FISCAL_BUYBACK_DEBT_ACCOUNTING_BRIDGE_2008_V130.csv`.

## Clave adicional V130 · Discount en Pesos
