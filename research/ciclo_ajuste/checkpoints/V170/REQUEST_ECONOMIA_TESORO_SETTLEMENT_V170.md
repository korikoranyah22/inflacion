# Solicitud al Ministerio de Economía / Tesoro · V170
...
- tabla de cuatro rondas: `E0_FISCAL_PUBLIC_BUYBACK_CALLS_2008_V170.csv`;
- resumen del strip: `E0_FISCAL_STRIP_BUYBACK_SUMMARY_2009_V170.csv`;
- cadena normativa: `E0_FISCAL_BUYBACK_SETTLEMENT_CHAIN_V170.csv`.
- matriz de comunicaciones directas: `E0_CAJA_TARGET_COMMUNICATION_MATRIX_V170.csv`;
- hoja de claves técnicas: sólo las filas `REQ133_ECON` de `E0_REQUEST_SEARCH_KEY_MATRIX_V170.csv`.



- puente contable trimestral: `E0_FISCAL_BUYBACK_DEBT_ACCOUNTING_BRIDGE_2008_V170.csv`.

## Clave adicional V170 · Discount en Pesos
...
## Clave V170 · expediente productor y submayores SIGADE/SIDIF
...
## Clave V170 · productor, sistemas y formato de salida demostrados
...
## Clave V170 · ruta COMDOC y comparadores contiguos
...
## Clave V170 · salida FindDoc y cadena C-41
...
## Clave V170 · AGAN/AMIDDF, sistema productor y pago parcial
...
## Clave V170 · productor exacto, índice AMIDDF y bifurcación de comisiones
...
## Clave V170 · exportación SICHE y test condicional C-55 por débito directo
...
## Clave V170 · capacidad SICHE demostrada y doble prioridad C-41/C-55
...
## Clave V170 · consultas SICHE nombradas y runbook exacto
...
## Clave V170 · repositorio histórico CUT 2007-2014
...
## Clave V170 · cuenta 230, códigos automáticos y conciliación
...
## Clave contemporánea V170 · SLU 2001-2005 y prueba de rama
...
## Clave V170 · tablas exactas, ausencia de historia y recuperación forense
...
## Clave V170 · SICHE, retención perpetua y migración
...
## Rectificación y ampliación V170 · Anexo K, mayorizado y respaldo bancario
...
## Rectificación V170 · excepción SAF 355 y ruta TGN/CGN/BNA
...
## Ampliación V170 · cierre 2008, archivo oficial y custodios nominados
...
## Ampliación V170 · universo C-41/C-42/C-55 y cadena completa
...
## Ampliación V170 · doble repositorio SIDIF, TRANSAF y certificación UAI
...
## V170 · objetos exactos de certificación y cierre
...
## V170 · notas exactas, SISIO y registro interno pre-GDE
...
## V170 · deber exacto del período, SISIO y papeles UAI
...
## Adenda V170 · doble identificador documental
