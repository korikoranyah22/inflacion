# Lista de presentación y seguimiento · V156
...
## Control V156 previo a cualquier autorización
...
## Control V156 · doble prioridad y consulta reproducible
...
## Control V156 · consultas nombradas
...
## Control V156 · repositorio CUT histórico
...
## Control V156 · código, cuenta 230 y conciliación
...
## Control V156 · reportes SLU y C55 contemporáneos
...
## Control V156 · tablas SLU y recuperación histórica
...
## Control V156 · SICHE, backups y migración SLU
...
## Control V156 · ruta SIGADE/SIDIF-Link/SICHE
...
## Control V156 · rectificación de precisión y rama Anexo K

- Mantener los seis pedidos en `DRAFT_NOT_SENT` hasta autorización expresa.
- No llamar error aritmético al 0,45 sin componentes fuente no redondeados.
- Adjuntar fila Anexo K, escalera oficial AGN, tabla de estados y objetos V156.
...
## Control V156 · vía especial y custodia
...
## Control V156 · dos cortes, dos fechas y dos custodias
...
## Control V156 · tercera rama sin anticipar el tipo
...
## Control V156 · búsqueda dual y tres fuentes
...
## Control previo V156 · SIGEN y legado
...
## Control previo V156 · constancias SISIO y doble ruta
