# Solicitud al Ministerio de Economía / Tesoro · V132
...
- tabla de cuatro rondas: `E0_FISCAL_PUBLIC_BUYBACK_CALLS_2008_V132.csv`;
- resumen del strip: `E0_FISCAL_STRIP_BUYBACK_SUMMARY_2009_V132.csv`;
- cadena normativa: `E0_FISCAL_BUYBACK_SETTLEMENT_CHAIN_V132.csv`.
- matriz de comunicaciones directas: `E0_CAJA_TARGET_COMMUNICATION_MATRIX_V132.csv`;
- hoja de claves técnicas: sólo las filas `REQ132_ECON` de `E0_REQUEST_SEARCH_KEY_MATRIX_V132.csv`.



- puente contable trimestral: `E0_FISCAL_BUYBACK_DEBT_ACCOUNTING_BRIDGE_2008_V132.csv`.

## Clave adicional V132 · Discount en Pesos
...
## Clave V132 · expediente productor y submayores SIGADE/SIDIF
