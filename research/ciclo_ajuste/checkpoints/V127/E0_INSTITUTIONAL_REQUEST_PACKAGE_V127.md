...
El paquete contiene 81 objetos trazados y 62 claves exactas. Las búsquedas se concentran en comunicación de la cuarta ronda 2008, instrucciones/asientos ejecutados, informes T+3 entregados, operaciones individuales del Discount en Pesos y pagos/bajas conciliados.

## Borradores incluidos

- Economía / Tesoro: `REQUEST_ECONOMIA_TESORO_SETTLEMENT_V127.md`
- BCRA / CRyL: `REQUEST_BCRA_CRYL_SETTLEMENT_V127.md`
- Banco Nación: `REQUEST_BNA_FIRST_STAGE_BLOTTER_V127.md`
- AGN: `REQUEST_AGN_2018_REPLY_V127.md`
- CNV: `REQUEST_CNV_CUSTODY_RECORDS_V127.md`
- Caja de Valores: `REQUEST_CAJA_SETTLEMENT_HOLDINGS_V127.md`

## Adjuntos mínimos

- `E0_CAJA_TARGET_COMMUNICATION_MATRIX_V127.csv`
- `E0_INFORMATION_REQUEST_TRACEABILITY_V127.csv`
- `E0_REQUEST_SEARCH_KEY_MATRIX_V127.csv`
- `E0_REQUEST_ATTACHMENT_MINIMUM_V127.csv`
- `E0_REQUEST_CLOSURE_CRITERIA_V127.csv`
- `E0_CAJA_CRYL_SETTLEMENT_STAGE_MATRIX_V127.csv`
- `E0_DEFERRED_MODALITY_EQUIVALENCE_AUDIT_V127.csv`
