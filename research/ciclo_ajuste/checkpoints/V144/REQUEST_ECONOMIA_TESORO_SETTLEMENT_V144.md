# Solicitud al Ministerio de Economía / Tesoro · V144
...
- tabla de cuatro rondas: `E0_FISCAL_PUBLIC_BUYBACK_CALLS_2008_V144.csv`;
- resumen del strip: `E0_FISCAL_STRIP_BUYBACK_SUMMARY_2009_V144.csv`;
- cadena normativa: `E0_FISCAL_BUYBACK_SETTLEMENT_CHAIN_V144.csv`.
- matriz de comunicaciones directas: `E0_CAJA_TARGET_COMMUNICATION_MATRIX_V144.csv`;
- hoja de claves técnicas: sólo las filas `REQ133_ECON` de `E0_REQUEST_SEARCH_KEY_MATRIX_V144.csv`.



- puente contable trimestral: `E0_FISCAL_BUYBACK_DEBT_ACCOUNTING_BRIDGE_2008_V144.csv`.

## Clave adicional V144 · Discount en Pesos
...
## Clave V144 · expediente productor y submayores SIGADE/SIDIF
...
## Clave V144 · productor, sistemas y formato de salida demostrados
...
## Clave V144 · ruta COMDOC y comparadores contiguos
...
## Clave V144 · salida FindDoc y cadena C-41
...
## Clave V144 · AGAN/AMIDDF, sistema productor y pago parcial
...
## Clave V144 · productor exacto, índice AMIDDF y bifurcación de comisiones
...
## Clave V144 · exportación SICHE y test condicional C-55 por débito directo
...
## Clave V144 · capacidad SICHE demostrada y doble prioridad C-41/C-55
...
## Clave V144 · consultas SICHE nombradas y runbook exacto
...
## Clave V144 · repositorio histórico CUT 2007-2014
...
## Clave V144 · cuenta 230, códigos automáticos y conciliación
...
## Clave contemporánea V144 · SLU 2001-2005 y prueba de rama
...
## Clave V144 · tablas exactas, ausencia de historia y recuperación forense
