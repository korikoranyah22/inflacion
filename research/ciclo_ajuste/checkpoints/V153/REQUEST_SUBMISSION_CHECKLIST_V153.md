# Lista de presentación y seguimiento · V153
...
## Control V153 previo a cualquier autorización
...
## Control V153 · doble prioridad y consulta reproducible
...
## Control V153 · consultas nombradas
...
## Control V153 · repositorio CUT histórico
...
## Control V153 · código, cuenta 230 y conciliación
...
## Control V153 · reportes SLU y C55 contemporáneos
...
## Control V153 · tablas SLU y recuperación histórica
...
## Control V153 · SICHE, backups y migración SLU
...
## Control V153 · ruta SIGADE/SIDIF-Link/SICHE
...
## Control V153 · rectificación de precisión y rama Anexo K

- Mantener los seis pedidos en `DRAFT_NOT_SENT` hasta autorización expresa.
- No llamar error aritmético al 0,45 sin componentes fuente no redondeados.
- Adjuntar fila Anexo K, escalera oficial AGN, tabla de estados y objetos V153.
...
## Control V153 · vía especial y custodia
...
## Control V153 · dos cortes, dos fechas y dos custodias
...
## Control V153 · tercera rama sin anticipar el tipo
...
## Control V153 · búsqueda dual y tres fuentes
