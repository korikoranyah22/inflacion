# Solicitud al Ministerio de Economía / Tesoro · V176
...
- tabla de cuatro rondas: `E0_FISCAL_PUBLIC_BUYBACK_CALLS_2008_V176.csv`;
- resumen del strip: `E0_FISCAL_STRIP_BUYBACK_SUMMARY_2009_V176.csv`;
- cadena normativa: `E0_FISCAL_BUYBACK_SETTLEMENT_CHAIN_V176.csv`.
- matriz de comunicaciones directas: `E0_CAJA_TARGET_COMMUNICATION_MATRIX_V176.csv`;
- hoja de claves técnicas: sólo las filas `REQ133_ECON` de `E0_REQUEST_SEARCH_KEY_MATRIX_V176.csv`.



- puente contable trimestral: `E0_FISCAL_BUYBACK_DEBT_ACCOUNTING_BRIDGE_2008_V176.csv`.

## Clave adicional V176 · Discount en Pesos
...
## Clave V176 · expediente productor y submayores SIGADE/SIDIF
...
## Clave V176 · productor, sistemas y formato de salida demostrados
...
## Clave V176 · ruta COMDOC y comparadores contiguos
...
## Clave V176 · salida FindDoc y cadena C-41
...
## Clave V176 · AGAN/AMIDDF, sistema productor y pago parcial
...
## Clave V176 · productor exacto, índice AMIDDF y bifurcación de comisiones
...
## Clave V176 · exportación SICHE y test condicional C-55 por débito directo
...
## Clave V176 · capacidad SICHE demostrada y doble prioridad C-41/C-55
...
## Clave V176 · consultas SICHE nombradas y runbook exacto
...
## Clave V176 · repositorio histórico CUT 2007-2014
...
## Clave V176 · cuenta 230, códigos automáticos y conciliación
...
## Clave contemporánea V176 · SLU 2001-2005 y prueba de rama
...
## Clave V176 · tablas exactas, ausencia de historia y recuperación forense
...
## Clave V176 · SICHE, retención perpetua y migración
...
## Rectificación y ampliación V176 · Anexo K, mayorizado y respaldo bancario
...
## Rectificación V176 · excepción SAF 355 y ruta TGN/CGN/BNA
...
## Ampliación V176 · cierre 2008, archivo oficial y custodios nominados
...
## Ampliación V176 · universo C-41/C-42/C-55 y cadena completa
...
## Ampliación V176 · doble repositorio SIDIF, TRANSAF y certificación UAI
...
## V176 · objetos exactos de certificación y cierre
...
## V176 · notas exactas, SISIO y registro interno pre-GDE
...
## V176 · deber exacto del período, SISIO y papeles UAI
...
## Adenda V176 · receptor contextual CGN y protocolo de búsqueda
...
## Adenda V176 · registro obligatorio CGN y corte temporal COMDOC
...
## Adenda V176 · Mesa SIGEN, metadatos CGN y custodia híbrida
...
## Adenda V176 · código NOT, CIDD, SPD y Archivo Digital
...
El ArchivoWeb público expone únicamente subtipos de informes; no ofrece `NOT`. Un cero allí no cierra la nota. Common Crawl no se reabrió porque el control V176 falló 2/2; cuarenta consultas siguen pendientes y los errores no son ausencia. Estado DRAFT_NOT_SENT; solicitudes 0; SAF355 0/5; ejecución 0/10.


## Adenda V176 · serie anual y expediente receptor
...
Common Crawl volvió a fallar 2/2 en el control V176; las 40 consultas siguen pendientes y no producen ausencia. Estado DRAFT_NOT_SENT; solicitudes 0; SAF355 0/5; ejecución bancaria 0/10.


## Adenda V176 · historial SISIO, remito y cuantificación antes/después
