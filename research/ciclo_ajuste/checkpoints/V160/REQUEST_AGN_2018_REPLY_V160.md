# Solicitud a la Auditoría General de la Nación · V160
...
Como hoja identificadora puede adjuntarse `E0_AGN_BODEN_REQUEST_PUBLIC_SCHEMA_V160.csv`, que contiene sólo UUID, nid, vid, fechas y metadatos públicos; no incluye datos personales del solicitante original.
...
## Clave V160 · proyecto 48 0237/09 y actuación final
...
## Clave V160 · identidad final cerrada y anexos trimestrales faltantes
...
## Clave V160 · remisión parlamentaria y archivo
...
## Clave V160 · inventario público y nota de archivo
