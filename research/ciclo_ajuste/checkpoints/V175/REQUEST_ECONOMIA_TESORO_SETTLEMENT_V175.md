# Solicitud al Ministerio de Economía / Tesoro · V175
...
- tabla de cuatro rondas: `E0_FISCAL_PUBLIC_BUYBACK_CALLS_2008_V175.csv`;
- resumen del strip: `E0_FISCAL_STRIP_BUYBACK_SUMMARY_2009_V175.csv`;
- cadena normativa: `E0_FISCAL_BUYBACK_SETTLEMENT_CHAIN_V175.csv`.
- matriz de comunicaciones directas: `E0_CAJA_TARGET_COMMUNICATION_MATRIX_V175.csv`;
- hoja de claves técnicas: sólo las filas `REQ133_ECON` de `E0_REQUEST_SEARCH_KEY_MATRIX_V175.csv`.



- puente contable trimestral: `E0_FISCAL_BUYBACK_DEBT_ACCOUNTING_BRIDGE_2008_V175.csv`.

## Clave adicional V175 · Discount en Pesos
...
## Clave V175 · expediente productor y submayores SIGADE/SIDIF
...
## Clave V175 · productor, sistemas y formato de salida demostrados
...
## Clave V175 · ruta COMDOC y comparadores contiguos
...
## Clave V175 · salida FindDoc y cadena C-41
...
## Clave V175 · AGAN/AMIDDF, sistema productor y pago parcial
...
## Clave V175 · productor exacto, índice AMIDDF y bifurcación de comisiones
...
## Clave V175 · exportación SICHE y test condicional C-55 por débito directo
...
## Clave V175 · capacidad SICHE demostrada y doble prioridad C-41/C-55
...
## Clave V175 · consultas SICHE nombradas y runbook exacto
...
## Clave V175 · repositorio histórico CUT 2007-2014
...
## Clave V175 · cuenta 230, códigos automáticos y conciliación
...
## Clave contemporánea V175 · SLU 2001-2005 y prueba de rama
...
## Clave V175 · tablas exactas, ausencia de historia y recuperación forense
...
## Clave V175 · SICHE, retención perpetua y migración
...
## Clave V175 · SIGADE, SIDIF-Link, SIDIF Central y SICHE

Estado: **BORRADOR_NO_ENVIADO**. Este texto no registra ni autoriza presentación.

Para el período 2008, la evidencia institucional ubica el circuito relevante en `SIGADE → SIDIF-Link → SIDIF Central`, hoy recuperable mediante SICHE. Se solicitan los registros y metadatos enumerados en `E0_SIDIF_LINK_SICHE_REQUEST_OBJECTS_V175.csv`: submayor/eventos SIGADE; lotes SIDIF-Link; formularios por partida y SIGADE; gastos por beneficiario; deuda exigible hasta 2008; detalle de asientos 2001-2012; extractos, saldos, logs y conciliación CUT; orden/expediente SAF 355; y la tabla de enlace entre ID SIGADE, formulario, cuenta, orden y movimiento bancario.
...
## Rectificación y ampliación V175 · Anexo K, mayorizado y respaldo bancario
...
## Rectificación V175 · excepción SAF 355 y ruta TGN/CGN/BNA
...
## Ampliación V175 · cierre 2008, archivo oficial y custodios nominados
...
## Ampliación V175 · universo C-41/C-42/C-55 y cadena completa
...
## Ampliación V175 · doble repositorio SIDIF, TRANSAF y certificación UAI
...
## V175 · objetos exactos de certificación y cierre
...
## V175 · notas exactas, SISIO y registro interno pre-GDE
...
## V175 · deber exacto del período, SISIO y papeles UAI
...
## Adenda V175 · receptor contextual CGN y protocolo de búsqueda
...
## Adenda V175 · registro obligatorio CGN y corte temporal COMDOC
...
## Adenda V175 · Mesa SIGEN, metadatos CGN y custodia híbrida
...
## Adenda V175 · código NOT, CIDD, SPD y Archivo Digital
...
El ArchivoWeb público expone únicamente subtipos de informes; no ofrece `NOT`. Un cero allí no cierra la nota. Common Crawl no se reabrió porque el control V175 falló 2/2; cuarenta consultas siguen pendientes y los errores no son ausencia. Estado DRAFT_NOT_SENT; solicitudes 0; SAF355 0/5; ejecución 0/10.


## Adenda V175 · serie anual y expediente receptor
...
Common Crawl volvió a fallar 2/2 en el control V175; las 40 consultas siguen pendientes y no producen ausencia. Estado DRAFT_NOT_SENT; solicitudes 0; SAF355 0/5; ejecución bancaria 0/10.
