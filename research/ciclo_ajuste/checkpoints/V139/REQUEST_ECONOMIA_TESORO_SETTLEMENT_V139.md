# Solicitud al Ministerio de Economía / Tesoro · V139
...
- tabla de cuatro rondas: `E0_FISCAL_PUBLIC_BUYBACK_CALLS_2008_V139.csv`;
- resumen del strip: `E0_FISCAL_STRIP_BUYBACK_SUMMARY_2009_V139.csv`;
- cadena normativa: `E0_FISCAL_BUYBACK_SETTLEMENT_CHAIN_V139.csv`.
- matriz de comunicaciones directas: `E0_CAJA_TARGET_COMMUNICATION_MATRIX_V139.csv`;
- hoja de claves técnicas: sólo las filas `REQ133_ECON` de `E0_REQUEST_SEARCH_KEY_MATRIX_V139.csv`.



- puente contable trimestral: `E0_FISCAL_BUYBACK_DEBT_ACCOUNTING_BRIDGE_2008_V139.csv`.

## Clave adicional V139 · Discount en Pesos
...
## Clave V139 · expediente productor y submayores SIGADE/SIDIF
...
## Clave V139 · productor, sistemas y formato de salida demostrados
...
## Clave V139 · ruta COMDOC y comparadores contiguos
...
## Clave V139 · salida FindDoc y cadena C-41
...
## Clave V139 · AGAN/AMIDDF, sistema productor y pago parcial
...
## Clave V139 · productor exacto, índice AMIDDF y bifurcación de comisiones
...
## Clave V139 · capacidad SICHE demostrada y doble prioridad C-41/C-55
