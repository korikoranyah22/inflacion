# Solicitud a la Auditoría General de la Nación · V139
...
Como hoja identificadora puede adjuntarse `E0_AGN_BODEN_REQUEST_PUBLIC_SCHEMA_V139.csv`, que contiene sólo UUID, nid, vid, fechas y metadatos públicos; no incluye datos personales del solicitante original.
...
## Clave V139 · proyecto 48 0237/09 y actuación final
...
## Clave V139 · identidad final cerrada y anexos trimestrales faltantes
...
## Clave V139 · remisión parlamentaria y archivo
...
## Clave V139 · inventario público y nota de archivo
