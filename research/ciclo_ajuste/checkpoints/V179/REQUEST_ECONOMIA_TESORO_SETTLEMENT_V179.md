# Solicitud al Ministerio de Economía / Tesoro · V179
...
- tabla de cuatro rondas: `E0_FISCAL_PUBLIC_BUYBACK_CALLS_2008_V179.csv`;
- resumen del strip: `E0_FISCAL_STRIP_BUYBACK_SUMMARY_2009_V179.csv`;
- cadena normativa: `E0_FISCAL_BUYBACK_SETTLEMENT_CHAIN_V179.csv`.
- matriz de comunicaciones directas: `E0_CAJA_TARGET_COMMUNICATION_MATRIX_V179.csv`;
- hoja de claves técnicas: sólo las filas `REQ133_ECON` de `E0_REQUEST_SEARCH_KEY_MATRIX_V179.csv`.



- puente contable trimestral: `E0_FISCAL_BUYBACK_DEBT_ACCOUNTING_BRIDGE_2008_V179.csv`.

## Clave adicional V179 · Discount en Pesos
...
## Clave V179 · expediente productor y submayores SIGADE/SIDIF
...
## Clave V179 · productor, sistemas y formato de salida demostrados
...
## Clave V179 · ruta COMDOC y comparadores contiguos
...
## Clave V179 · salida FindDoc y cadena C-41
...
## Clave V179 · AGAN/AMIDDF, sistema productor y pago parcial
...
## Clave V179 · productor exacto, índice AMIDDF y bifurcación de comisiones
...
## Clave V179 · exportación SICHE y test condicional C-55 por débito directo
...
## Clave V179 · capacidad SICHE demostrada y doble prioridad C-41/C-55
...
## Clave V179 · consultas SICHE nombradas y runbook exacto
...
## Clave V179 · repositorio histórico CUT 2007-2014
...
## Clave V179 · cuenta 230, códigos automáticos y conciliación
...
## Clave contemporánea V179 · SLU 2001-2005 y prueba de rama
...
## Clave V179 · tablas exactas, ausencia de historia y recuperación forense
...
## Clave V179 · SICHE, retención perpetua y migración
...
## Clave V179 · SIGADE, SIDIF-Link, SIDIF Central y SICHE

Estado: **BORRADOR_NO_ENVIADO**. Este texto no registra ni autoriza presentación.

Para el período 2008, la evidencia institucional ubica el circuito relevante en `SIGADE → SIDIF-Link → SIDIF Central`, hoy recuperable mediante SICHE. Se solicitan los registros y metadatos enumerados en `E0_SIDIF_LINK_SICHE_REQUEST_OBJECTS_V179.csv`: submayor/eventos SIGADE; lotes SIDIF-Link; formularios por partida y SIGADE; gastos por beneficiario; deuda exigible hasta 2008; detalle de asientos 2001-2012; extractos, saldos, logs y conciliación CUT; orden/expediente SAF 355; y la tabla de enlace entre ID SIGADE, formulario, cuenta, orden y movimiento bancario.
...
## Rectificación y ampliación V179 · Anexo K, mayorizado y respaldo bancario
...
## Rectificación V179 · excepción SAF 355 y ruta TGN/CGN/BNA
...
## Ampliación V179 · cierre 2008, archivo oficial y custodios nominados
...
## Ampliación V179 · universo C-41/C-42/C-55 y cadena completa
...
## Ampliación V179 · doble repositorio SIDIF, TRANSAF y certificación UAI
...
## V179 · objetos exactos de certificación y cierre
...
## V179 · notas exactas, SISIO y registro interno pre-GDE
...
## V179 · deber exacto del período, SISIO y papeles UAI
...
## Adenda V179 · receptor contextual CGN y protocolo de búsqueda
...
## Adenda V179 · registro obligatorio CGN y corte temporal COMDOC
