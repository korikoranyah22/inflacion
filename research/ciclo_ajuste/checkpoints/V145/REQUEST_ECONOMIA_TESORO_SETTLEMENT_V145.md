# Solicitud al Ministerio de Economía / Tesoro · V145
...
- tabla de cuatro rondas: `E0_FISCAL_PUBLIC_BUYBACK_CALLS_2008_V145.csv`;
- resumen del strip: `E0_FISCAL_STRIP_BUYBACK_SUMMARY_2009_V145.csv`;
- cadena normativa: `E0_FISCAL_BUYBACK_SETTLEMENT_CHAIN_V145.csv`.
- matriz de comunicaciones directas: `E0_CAJA_TARGET_COMMUNICATION_MATRIX_V145.csv`;
- hoja de claves técnicas: sólo las filas `REQ133_ECON` de `E0_REQUEST_SEARCH_KEY_MATRIX_V145.csv`.



- puente contable trimestral: `E0_FISCAL_BUYBACK_DEBT_ACCOUNTING_BRIDGE_2008_V145.csv`.

## Clave adicional V145 · Discount en Pesos
...
## Clave V145 · expediente productor y submayores SIGADE/SIDIF
...
## Clave V145 · productor, sistemas y formato de salida demostrados
...
## Clave V145 · ruta COMDOC y comparadores contiguos
...
## Clave V145 · salida FindDoc y cadena C-41
...
## Clave V145 · AGAN/AMIDDF, sistema productor y pago parcial
...
## Clave V145 · productor exacto, índice AMIDDF y bifurcación de comisiones
...
## Clave V145 · exportación SICHE y test condicional C-55 por débito directo
...
## Clave V145 · capacidad SICHE demostrada y doble prioridad C-41/C-55
...
## Clave V145 · consultas SICHE nombradas y runbook exacto
...
## Clave V145 · repositorio histórico CUT 2007-2014
...
## Clave V145 · cuenta 230, códigos automáticos y conciliación
...
## Clave contemporánea V145 · SLU 2001-2005 y prueba de rama
...
## Clave V145 · tablas exactas, ausencia de historia y recuperación forense
...
## Clave V145 · SICHE, retención perpetua y migración
