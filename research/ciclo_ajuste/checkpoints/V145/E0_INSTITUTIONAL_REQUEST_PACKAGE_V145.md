...
- Economía / Tesoro: `REQUEST_ECONOMIA_TESORO_SETTLEMENT_V145.md`
- BCRA / CRyL: `REQUEST_BCRA_CRYL_SETTLEMENT_V145.md`
- Banco Nación: `REQUEST_BNA_FIRST_STAGE_BLOTTER_V145.md`
- AGN: `REQUEST_AGN_2018_REPLY_V145.md`
- CNV: `REQUEST_CNV_CUSTODY_RECORDS_V145.md`
- Caja de Valores: `REQUEST_CAJA_SETTLEMENT_HOLDINGS_V145.md`

## Adjuntos mínimos

- `E0_CAJA_TARGET_COMMUNICATION_MATRIX_V145.csv`
- `E0_INFORMATION_REQUEST_TRACEABILITY_V145.csv`
- `E0_REQUEST_SEARCH_KEY_MATRIX_V145.csv`
- `E0_REQUEST_ATTACHMENT_MINIMUM_V145.csv`
- `E0_REQUEST_CLOSURE_CRITERIA_V145.csv`
- `E0_CAJA_CRYL_SETTLEMENT_STAGE_MATRIX_V145.csv`
- `E0_DEFERRED_MODALITY_EQUIVALENCE_AUDIT_V145.csv`
...
## Clave V145 · GDP Units y cancelación contractual
...
## Clave V145 · tablas SLU y recuperación histórica

El pedido Economía/Tesoro incorpora las doce tablas exactas de cuenta, movimiento, aplicación automática y Libro Banco; incluye activas, bajas y rehabilitadas, backups/snapshots 2006-2009, versión y migración v7→v9.0, historial de correcciones, C10 de recurso y C55/cheque como controles. Adjuntos específicos: `E0_SLU_BASE_TABLE_DICTIONARY_V145.csv`, `E0_SLU_HISTORICAL_RECOVERY_STRATEGY_V145.csv`, `E0_SLU_AUTOMATIC_EXPENSE_MAPPING_CHAIN_V145.csv` y `E0_SLU_TABLE_REQUEST_FIELD_MATRIX_V145.csv`. Estado: `DRAFT_NOT_SENT`.

## Clave V145 · obligación de resguardo y consulta SICHE
