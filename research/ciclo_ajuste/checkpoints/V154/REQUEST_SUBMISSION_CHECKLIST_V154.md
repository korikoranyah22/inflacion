# Lista de presentación y seguimiento · V154
...
## Control V154 previo a cualquier autorización
...
## Control V154 · doble prioridad y consulta reproducible
...
## Control V154 · consultas nombradas
...
## Control V154 · repositorio CUT histórico
...
## Control V154 · código, cuenta 230 y conciliación
...
## Control V154 · reportes SLU y C55 contemporáneos
...
## Control V154 · tablas SLU y recuperación histórica
...
## Control V154 · SICHE, backups y migración SLU
...
## Control V154 · ruta SIGADE/SIDIF-Link/SICHE
...
## Control V154 · rectificación de precisión y rama Anexo K

- Mantener los seis pedidos en `DRAFT_NOT_SENT` hasta autorización expresa.
- No llamar error aritmético al 0,45 sin componentes fuente no redondeados.
- Adjuntar fila Anexo K, escalera oficial AGN, tabla de estados y objetos V154.
...
## Control V154 · vía especial y custodia
...
## Control V154 · dos cortes, dos fechas y dos custodias
...
## Control V154 · tercera rama sin anticipar el tipo
...
## Control V154 · búsqueda dual y tres fuentes
