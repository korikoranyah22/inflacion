# Lista de presentación y seguimiento · V180
...
## Control V180 previo a cualquier autorización
...
## Control V180 · doble prioridad y consulta reproducible
...
## Control V180 · consultas nombradas
...
## Control V180 · repositorio CUT histórico
...
## Control V180 · código, cuenta 230 y conciliación
...
## Control V180 · reportes SLU y C55 contemporáneos
...
## Control V180 · tablas SLU y recuperación histórica
...
## Control V180 · SICHE, backups y migración SLU
...
## Control V180 · ruta SIGADE/SIDIF-Link/SICHE
...
## Control V180 · rectificación de precisión y rama Anexo K

- Mantener los seis pedidos en `DRAFT_NOT_SENT` hasta autorización expresa.
- No llamar error aritmético al 0,45 sin componentes fuente no redondeados.
- Adjuntar fila Anexo K, escalera oficial AGN, tabla de estados y objetos V180.
...
## Control V180 · vía especial y custodia
...
## Control V180 · dos cortes, dos fechas y dos custodias
...
## Control V180 · tercera rama sin anticipar el tipo
...
## Control V180 · búsqueda dual y tres fuentes
...
## Control previo V180 · SIGEN y legado
...
## Control previo V180 · constancias SISIO y doble ruta
...
## Control previo V180 · plan, supervisión y archivo
...
## Control previo V180 · cadena preliminar-final, reforma y conteos
...
## Control previo V180 · siglas, denominadores, lifecycle y no transposición SAF355
...
## Control previo V180 · glosario oficial, multi-entidad y puente jurídico
