# Solicitud al Ministerio de Economía / Tesoro · V122
...
Dos tablas oficiales contemporáneas publican, por denominación exacta, los códigos históricos 5426, 5427, 45698 y 45701 para esas cuatro especies, respectivamente. Solicito confirmar el tipo y sistema de esos códigos y su equivalencia vigente en 2008. Para ARARGE03G415 no se localizó un código público propio: no solicito que se le atribuya 5426 por herencia del título principal, sino el registro o tabla de la subespecie.
...
n) tabla, diccionario o constancia que vincule cada ISIN con el código interno usado por Economía, Caja y/o CRyL —incluidos 5426, 5427, 45698 y 45701—, con denominación, tipo de código, sistema y fechas de vigencia; y el código propio de ARARGE03G415 si obra registrado.
...
- tabla de cuatro rondas: `E0_FISCAL_PUBLIC_BUYBACK_CALLS_2008_V122.csv`;
- resumen del strip: `E0_FISCAL_STRIP_BUYBACK_SUMMARY_2009_V122.csv`;
- cadena normativa: `E0_FISCAL_BUYBACK_SETTLEMENT_CHAIN_V122.csv`.
- hoja de claves técnicas: sólo las filas `REQ122_ECON` de `E0_REQUEST_SEARCH_KEY_MATRIX_V122.csv`.
