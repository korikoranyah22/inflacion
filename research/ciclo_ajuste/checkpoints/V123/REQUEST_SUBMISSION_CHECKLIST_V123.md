# Lista de presentación y seguimiento · V123
...
- aplicar `E0_REQUEST_ATTACHMENT_MINIMUM_V123.csv` y filtrar por organismo cuando corresponda;
...
- comparar cada archivo recibido con `E0_INFORMATION_REQUEST_TRACEABILITY_V123.csv`.
- comprobar que una búsqueda de actuaciones 2008–2009 no haya sido limitada a GDE;
- comprobar si la respuesta buscó las claves del organismo en `E0_REQUEST_SEARCH_KEY_MATRIX_V123.csv` o identificó equivalencias técnicas;
- evaluar toda inexistencia contra los catorce controles de `E0_NEGATIVE_RESPONSE_ADEQUACY_V123.csv`.
...
- no tomar la práctica de Recepción Diferida documentada en 2009 como prueba de la edición vigente en 2008;
...
- aplicar los criterios de `E0_REQUEST_CLOSURE_CRITERIA_V123.csv` antes de cambiar el estado de una brecha.
