# Solicitud al Ministerio de Economía / Tesoro · V168
...
- tabla de cuatro rondas: `E0_FISCAL_PUBLIC_BUYBACK_CALLS_2008_V168.csv`;
- resumen del strip: `E0_FISCAL_STRIP_BUYBACK_SUMMARY_2009_V168.csv`;
- cadena normativa: `E0_FISCAL_BUYBACK_SETTLEMENT_CHAIN_V168.csv`.
- matriz de comunicaciones directas: `E0_CAJA_TARGET_COMMUNICATION_MATRIX_V168.csv`;
- hoja de claves técnicas: sólo las filas `REQ133_ECON` de `E0_REQUEST_SEARCH_KEY_MATRIX_V168.csv`.



- puente contable trimestral: `E0_FISCAL_BUYBACK_DEBT_ACCOUNTING_BRIDGE_2008_V168.csv`.

## Clave adicional V168 · Discount en Pesos
...
## Clave V168 · expediente productor y submayores SIGADE/SIDIF
...
## Clave V168 · productor, sistemas y formato de salida demostrados
...
## Clave V168 · ruta COMDOC y comparadores contiguos
...
## Clave V168 · salida FindDoc y cadena C-41
...
## Clave V168 · AGAN/AMIDDF, sistema productor y pago parcial
...
## Clave V168 · productor exacto, índice AMIDDF y bifurcación de comisiones
...
## Clave V168 · exportación SICHE y test condicional C-55 por débito directo
...
## Clave V168 · capacidad SICHE demostrada y doble prioridad C-41/C-55
...
## Clave V168 · consultas SICHE nombradas y runbook exacto
...
## Clave V168 · repositorio histórico CUT 2007-2014
...
## Clave V168 · cuenta 230, códigos automáticos y conciliación
...
## Clave contemporánea V168 · SLU 2001-2005 y prueba de rama
...
## Clave V168 · tablas exactas, ausencia de historia y recuperación forense
...
## Clave V168 · SICHE, retención perpetua y migración
...
## Clave V168 · SIGADE, SIDIF-Link, SIDIF Central y SICHE

Estado: **BORRADOR_NO_ENVIADO**. Este texto no registra ni autoriza presentación.

Para el período 2008, la evidencia institucional ubica el circuito relevante en `SIGADE → SIDIF-Link → SIDIF Central`, hoy recuperable mediante SICHE. Se solicitan los registros y metadatos enumerados en `E0_SIDIF_LINK_SICHE_REQUEST_OBJECTS_V168.csv`: submayor/eventos SIGADE; lotes SIDIF-Link; formularios por partida y SIGADE; gastos por beneficiario; deuda exigible hasta 2008; detalle de asientos 2001-2012; extractos, saldos, logs y conciliación CUT; orden/expediente SAF 355; y la tabla de enlace entre ID SIGADE, formulario, cuenta, orden y movimiento bancario.
...
## Rectificación y ampliación V168 · Anexo K, mayorizado y respaldo bancario
...
## Rectificación V168 · excepción SAF 355 y ruta TGN/CGN/BNA
...
## Ampliación V168 · cierre 2008, archivo oficial y custodios nominados
...
## Ampliación V168 · universo C-41/C-42/C-55 y cadena completa
...
## Ampliación V168 · doble repositorio SIDIF, TRANSAF y certificación UAI
...
## V168 · objetos exactos de certificación y cierre
...
## V168 · notas exactas, SISIO y registro interno pre-GDE
...
## V168 · deber exacto del período, SISIO y papeles UAI
