# Solicitud al Ministerio de Economía / Tesoro · V167
...
- tabla de cuatro rondas: `E0_FISCAL_PUBLIC_BUYBACK_CALLS_2008_V167.csv`;
- resumen del strip: `E0_FISCAL_STRIP_BUYBACK_SUMMARY_2009_V167.csv`;
- cadena normativa: `E0_FISCAL_BUYBACK_SETTLEMENT_CHAIN_V167.csv`.
- matriz de comunicaciones directas: `E0_CAJA_TARGET_COMMUNICATION_MATRIX_V167.csv`;
- hoja de claves técnicas: sólo las filas `REQ133_ECON` de `E0_REQUEST_SEARCH_KEY_MATRIX_V167.csv`.



- puente contable trimestral: `E0_FISCAL_BUYBACK_DEBT_ACCOUNTING_BRIDGE_2008_V167.csv`.

## Clave adicional V167 · Discount en Pesos
...
## Clave V167 · expediente productor y submayores SIGADE/SIDIF
...
## Clave V167 · productor, sistemas y formato de salida demostrados
...
## Clave V167 · ruta COMDOC y comparadores contiguos
...
## Clave V167 · salida FindDoc y cadena C-41
...
## Clave V167 · AGAN/AMIDDF, sistema productor y pago parcial
...
## Clave V167 · productor exacto, índice AMIDDF y bifurcación de comisiones
...
## Clave V167 · exportación SICHE y test condicional C-55 por débito directo
...
## Clave V167 · capacidad SICHE demostrada y doble prioridad C-41/C-55
...
## Clave V167 · consultas SICHE nombradas y runbook exacto
...
## Clave V167 · repositorio histórico CUT 2007-2014
...
## Clave V167 · cuenta 230, códigos automáticos y conciliación
...
## Clave contemporánea V167 · SLU 2001-2005 y prueba de rama
...
## Clave V167 · tablas exactas, ausencia de historia y recuperación forense
...
## Clave V167 · SICHE, retención perpetua y migración
...
## Clave V167 · SIGADE, SIDIF-Link, SIDIF Central y SICHE

Estado: **BORRADOR_NO_ENVIADO**. Este texto no registra ni autoriza presentación.

Para el período 2008, la evidencia institucional ubica el circuito relevante en `SIGADE → SIDIF-Link → SIDIF Central`, hoy recuperable mediante SICHE. Se solicitan los registros y metadatos enumerados en `E0_SIDIF_LINK_SICHE_REQUEST_OBJECTS_V167.csv`: submayor/eventos SIGADE; lotes SIDIF-Link; formularios por partida y SIGADE; gastos por beneficiario; deuda exigible hasta 2008; detalle de asientos 2001-2012; extractos, saldos, logs y conciliación CUT; orden/expediente SAF 355; y la tabla de enlace entre ID SIGADE, formulario, cuenta, orden y movimiento bancario.
...
## Rectificación y ampliación V167 · Anexo K, mayorizado y respaldo bancario
...
## Rectificación V167 · excepción SAF 355 y ruta TGN/CGN/BNA
...
## Ampliación V167 · cierre 2008, archivo oficial y custodios nominados
...
## Ampliación V167 · universo C-41/C-42/C-55 y cadena completa
...
## Ampliación V167 · doble repositorio SIDIF, TRANSAF y certificación UAI
...
## V167 · objetos exactos de certificación y cierre
...
## V167 · notas exactas, SISIO y registro interno pre-GDE
...
## V167 · deber exacto del período, SISIO y papeles UAI
