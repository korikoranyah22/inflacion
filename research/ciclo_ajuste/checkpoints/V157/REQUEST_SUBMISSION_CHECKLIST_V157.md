# Lista de presentación y seguimiento · V157
...
## Control V157 previo a cualquier autorización
...
## Control V157 · doble prioridad y consulta reproducible
...
## Control V157 · consultas nombradas
...
## Control V157 · repositorio CUT histórico
...
## Control V157 · código, cuenta 230 y conciliación
...
## Control V157 · reportes SLU y C55 contemporáneos
...
## Control V157 · tablas SLU y recuperación histórica
...
## Control V157 · SICHE, backups y migración SLU
...
## Control V157 · ruta SIGADE/SIDIF-Link/SICHE
...
## Control V157 · rectificación de precisión y rama Anexo K

- Mantener los seis pedidos en `DRAFT_NOT_SENT` hasta autorización expresa.
- No llamar error aritmético al 0,45 sin componentes fuente no redondeados.
- Adjuntar fila Anexo K, escalera oficial AGN, tabla de estados y objetos V157.
...
## Control V157 · vía especial y custodia
...
## Control V157 · dos cortes, dos fechas y dos custodias
...
## Control V157 · tercera rama sin anticipar el tipo
...
## Control V157 · búsqueda dual y tres fuentes
...
## Control previo V157 · SIGEN y legado
...
## Control previo V157 · constancias SISIO y doble ruta
...
## Control previo V157 · plan, supervisión y archivo
