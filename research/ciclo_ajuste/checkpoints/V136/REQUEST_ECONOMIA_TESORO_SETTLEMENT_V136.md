# Solicitud al Ministerio de Economía / Tesoro · V136
...
- tabla de cuatro rondas: `E0_FISCAL_PUBLIC_BUYBACK_CALLS_2008_V136.csv`;
- resumen del strip: `E0_FISCAL_STRIP_BUYBACK_SUMMARY_2009_V136.csv`;
- cadena normativa: `E0_FISCAL_BUYBACK_SETTLEMENT_CHAIN_V136.csv`.
- matriz de comunicaciones directas: `E0_CAJA_TARGET_COMMUNICATION_MATRIX_V136.csv`;
- hoja de claves técnicas: sólo las filas `REQ133_ECON` de `E0_REQUEST_SEARCH_KEY_MATRIX_V136.csv`.



- puente contable trimestral: `E0_FISCAL_BUYBACK_DEBT_ACCOUNTING_BRIDGE_2008_V136.csv`.

## Clave adicional V136 · Discount en Pesos
...
## Clave V136 · expediente productor y submayores SIGADE/SIDIF
...
## Clave V136 · productor, sistemas y formato de salida demostrados
...
## Clave V136 · ruta COMDOC y comparadores contiguos
...
## Clave V136 · salida FindDoc y cadena C-41
