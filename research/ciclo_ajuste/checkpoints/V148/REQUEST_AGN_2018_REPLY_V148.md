# Solicitud a la Auditoría General de la Nación · V148
...
Como hoja identificadora puede adjuntarse `E0_AGN_BODEN_REQUEST_PUBLIC_SCHEMA_V148.csv`, que contiene sólo UUID, nid, vid, fechas y metadatos públicos; no incluye datos personales del solicitante original.
...
## Clave V148 · proyecto 48 0237/09 y actuación final
...
## Clave V148 · identidad final cerrada y anexos trimestrales faltantes
...
## Clave V148 · remisión parlamentaria y archivo
...
## Clave V148 · inventario público y nota de archivo
