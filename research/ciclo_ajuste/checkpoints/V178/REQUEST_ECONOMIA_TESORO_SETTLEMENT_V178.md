# Solicitud al Ministerio de Economía / Tesoro · V178
...
- tabla de cuatro rondas: `E0_FISCAL_PUBLIC_BUYBACK_CALLS_2008_V178.csv`;
- resumen del strip: `E0_FISCAL_STRIP_BUYBACK_SUMMARY_2009_V178.csv`;
- cadena normativa: `E0_FISCAL_BUYBACK_SETTLEMENT_CHAIN_V178.csv`.
- matriz de comunicaciones directas: `E0_CAJA_TARGET_COMMUNICATION_MATRIX_V178.csv`;
- hoja de claves técnicas: sólo las filas `REQ133_ECON` de `E0_REQUEST_SEARCH_KEY_MATRIX_V178.csv`.



- puente contable trimestral: `E0_FISCAL_BUYBACK_DEBT_ACCOUNTING_BRIDGE_2008_V178.csv`.

## Clave adicional V178 · Discount en Pesos
...
## Clave V178 · expediente productor y submayores SIGADE/SIDIF
...
## Clave V178 · productor, sistemas y formato de salida demostrados
...
## Clave V178 · ruta COMDOC y comparadores contiguos
...
## Clave V178 · salida FindDoc y cadena C-41
...
## Clave V178 · AGAN/AMIDDF, sistema productor y pago parcial
...
El custodio directo identificado es el Archivo General de Administración Nacional (`AGAN`) y su sistema `AMIDDF`, que reciben, ordenan, custodian, describen y digitalizan documentación financiera respaldatoria y originales en papel originados en movimientos de fondos de los SAF. Por `71597`, `152677` y `2876`, cuenta `83106000`, renglón `COMISIONES - BANCO NACION` e importe agregado `ARS 32.270,30`, se solicitan ficha de índice, signatura, caja, cuerpo, folios, imágenes y copia de todos los anexos: formulario original cualquiera sea su tipo, notas, lista diaria firmada de selección, autorizaciones si correspondían, boletos, débitos, eventuales C-41/C-55 y demás respaldos. La competencia general del archivo no se presenta como prueba de que esas piezas concretas ya hayan sido localizadas.
...
## Clave V178 · productor exacto, índice AMIDDF y bifurcación de comisiones
...
## Clave V178 · exportación SICHE y test condicional C-55 por débito directo
...
Filtros iniciales comunes: `SAF 355`, ejercicio `2008`, números SIDIF `71597`, `152677` y `2876`, identificador SIGADE `83106000`, concepto `COMISIONES - BANCO NACION`, partida `7.2.8` e importe agregado `$32.270,30`. Buscar primero sin restricción de tipo; luego `C-41` y `C-55` en paralelo; usar `C-42` en SLU y `C-35` en SIDIF Central como fallbacks, sin asumir de antemano cuál corresponde.
...
## Clave V178 · capacidad SICHE demostrada y doble prioridad C-41/C-55
...
## Clave V178 · consultas SICHE nombradas y runbook exacto
...
## Clave V178 · repositorio histórico CUT 2007-2014
...
## Clave V178 · cuenta 230, códigos automáticos y conciliación
...
## Clave contemporánea V178 · SLU 2001-2005 y prueba de rama
...
## Clave V178 · tablas exactas, ausencia de historia y recuperación forense
...
## Clave V178 · SICHE, retención perpetua y migración
...
## Clave V178 · SIGADE, SIDIF-Link, SIDIF Central y SICHE

Estado: **BORRADOR_NO_ENVIADO**. Este texto no registra ni autoriza presentación.

Para el período 2008, la evidencia institucional ubica el circuito relevante en `SIGADE → SIDIF-Link → SIDIF Central`, hoy recuperable mediante SICHE. Se solicitan los registros y metadatos enumerados en `E0_SIDIF_LINK_SICHE_REQUEST_OBJECTS_V178.csv`: submayor/eventos SIGADE; lotes SIDIF-Link; formularios por partida y SIGADE; gastos por beneficiario; deuda exigible hasta 2008; detalle de asientos 2001-2012; extractos, saldos, logs y conciliación CUT; orden/expediente SAF 355; y la tabla de enlace entre ID SIGADE, formulario, cuenta, orden y movimiento bancario.
...
## Rectificación y ampliación V178 · Anexo K, mayorizado y respaldo bancario
...
## Rectificación V178 · excepción SAF 355 y ruta TGN/CGN/BNA
...
## Ampliación V178 · cierre 2008, archivo oficial y custodios nominados
...
## Ampliación V178 · universo C-41/C-42/C-55 y cadena completa
...
## Ampliación V178 · doble repositorio SIDIF, TRANSAF y certificación UAI
...
## V178 · objetos exactos de certificación y cierre
...
## V178 · notas exactas, SISIO y registro interno pre-GDE
...
## V178 · deber exacto del período, SISIO y papeles UAI
...
## Adenda V178 · receptor contextual CGN y protocolo de búsqueda
...
## Adenda V178 · registro obligatorio CGN y corte temporal COMDOC
...
## Adenda V178 · Mesa SIGEN, metadatos CGN y custodia híbrida
...
## Adenda V178 · código NOT, CIDD, SPD y Archivo Digital
...
El ArchivoWeb público expone únicamente subtipos de informes; no ofrece `NOT`. Un cero allí no cierra la nota. Common Crawl no se reabrió porque el control V178 falló 2/2; cuarenta consultas siguen pendientes y los errores no son ausencia. Estado DRAFT_NOT_SENT; solicitudes 0; SAF355 0/5; ejecución 0/10.


## Adenda V178 · serie anual y expediente receptor
...
Common Crawl volvió a fallar 2/2 en el control V178; las 40 consultas siguen pendientes y no producen ausencia. Estado DRAFT_NOT_SENT; solicitudes 0; SAF355 0/5; ejecución bancaria 0/10.


## Adenda V178 · historial SISIO, remito y cuantificación antes/después
...
## Adenda V178 · clave compuesta, historial y disposición SISIO
