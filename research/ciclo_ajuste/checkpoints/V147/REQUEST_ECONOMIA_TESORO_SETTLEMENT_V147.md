# Solicitud al Ministerio de Economía / Tesoro · V147
...
- tabla de cuatro rondas: `E0_FISCAL_PUBLIC_BUYBACK_CALLS_2008_V147.csv`;
- resumen del strip: `E0_FISCAL_STRIP_BUYBACK_SUMMARY_2009_V147.csv`;
- cadena normativa: `E0_FISCAL_BUYBACK_SETTLEMENT_CHAIN_V147.csv`.
- matriz de comunicaciones directas: `E0_CAJA_TARGET_COMMUNICATION_MATRIX_V147.csv`;
- hoja de claves técnicas: sólo las filas `REQ133_ECON` de `E0_REQUEST_SEARCH_KEY_MATRIX_V147.csv`.



- puente contable trimestral: `E0_FISCAL_BUYBACK_DEBT_ACCOUNTING_BRIDGE_2008_V147.csv`.

## Clave adicional V147 · Discount en Pesos
...
## Clave V147 · expediente productor y submayores SIGADE/SIDIF
...
## Clave V147 · productor, sistemas y formato de salida demostrados
...
## Clave V147 · ruta COMDOC y comparadores contiguos
...
## Clave V147 · salida FindDoc y cadena C-41
...
## Clave V147 · AGAN/AMIDDF, sistema productor y pago parcial
...
## Clave V147 · productor exacto, índice AMIDDF y bifurcación de comisiones
...
## Clave V147 · exportación SICHE y test condicional C-55 por débito directo
...
## Clave V147 · capacidad SICHE demostrada y doble prioridad C-41/C-55
...
## Clave V147 · consultas SICHE nombradas y runbook exacto
...
## Clave V147 · repositorio histórico CUT 2007-2014
...
## Clave V147 · cuenta 230, códigos automáticos y conciliación
...
## Clave contemporánea V147 · SLU 2001-2005 y prueba de rama
...
## Clave V147 · tablas exactas, ausencia de historia y recuperación forense
...
## Clave V147 · SICHE, retención perpetua y migración
...
## Clave V147 · SIGADE, SIDIF-Link, SIDIF Central y SICHE

Estado: **BORRADOR_NO_ENVIADO**. Este texto no registra ni autoriza presentación.

Para el período 2008, la evidencia institucional ubica el circuito relevante en `SIGADE → SIDIF-Link → SIDIF Central`, hoy recuperable mediante SICHE. Se solicitan los registros y metadatos enumerados en `E0_SIDIF_LINK_SICHE_REQUEST_OBJECTS_V147.csv`: submayor/eventos SIGADE; lotes SIDIF-Link; formularios por partida y SIGADE; gastos por beneficiario; deuda exigible hasta 2008; detalle de asientos 2001-2012; extractos, saldos, logs y conciliación CUT; orden/expediente SAF 355; y la tabla de enlace entre ID SIGADE, formulario, cuenta, orden y movimiento bancario.
