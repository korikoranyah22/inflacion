# Solicitud al Ministerio de Economía / Tesoro · V165
...
- tabla de cuatro rondas: `E0_FISCAL_PUBLIC_BUYBACK_CALLS_2008_V165.csv`;
- resumen del strip: `E0_FISCAL_STRIP_BUYBACK_SUMMARY_2009_V165.csv`;
- cadena normativa: `E0_FISCAL_BUYBACK_SETTLEMENT_CHAIN_V165.csv`.
- matriz de comunicaciones directas: `E0_CAJA_TARGET_COMMUNICATION_MATRIX_V165.csv`;
- hoja de claves técnicas: sólo las filas `REQ133_ECON` de `E0_REQUEST_SEARCH_KEY_MATRIX_V165.csv`.



- puente contable trimestral: `E0_FISCAL_BUYBACK_DEBT_ACCOUNTING_BRIDGE_2008_V165.csv`.

## Clave adicional V165 · Discount en Pesos
...
## Clave V165 · expediente productor y submayores SIGADE/SIDIF
...
## Clave V165 · productor, sistemas y formato de salida demostrados
...
## Clave V165 · ruta COMDOC y comparadores contiguos
...
## Clave V165 · salida FindDoc y cadena C-41
...
## Clave V165 · AGAN/AMIDDF, sistema productor y pago parcial
...
## Clave V165 · productor exacto, índice AMIDDF y bifurcación de comisiones
...
## Clave V165 · exportación SICHE y test condicional C-55 por débito directo
...
## Clave V165 · capacidad SICHE demostrada y doble prioridad C-41/C-55
...
## Clave V165 · consultas SICHE nombradas y runbook exacto
...
## Clave V165 · repositorio histórico CUT 2007-2014
...
## Clave V165 · cuenta 230, códigos automáticos y conciliación
...
## Clave contemporánea V165 · SLU 2001-2005 y prueba de rama
...
## Clave V165 · tablas exactas, ausencia de historia y recuperación forense
...
## Clave V165 · SICHE, retención perpetua y migración
...
## Rectificación y ampliación V165 · Anexo K, mayorizado y respaldo bancario
...
## Rectificación V165 · excepción SAF 355 y ruta TGN/CGN/BNA
...
## Ampliación V165 · cierre 2008, archivo oficial y custodios nominados
...
## Ampliación V165 · universo C-41/C-42/C-55 y cadena completa
...
## Ampliación V165 · doble repositorio SIDIF, TRANSAF y certificación UAI
...
## V165 · objetos exactos de certificación y cierre
...
## V165 · notas exactas, SISIO y registro interno pre-GDE
...
## V165 · deber exacto del período, SISIO y papeles UAI
