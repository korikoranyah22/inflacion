# Solicitud a la Auditoría General de la Nación · V165
...
Como hoja identificadora puede adjuntarse `E0_AGN_BODEN_REQUEST_PUBLIC_SCHEMA_V165.csv`, que contiene sólo UUID, nid, vid, fechas y metadatos públicos; no incluye datos personales del solicitante original.
...
## Clave V165 · proyecto 48 0237/09 y actuación final
...
## Clave V165 · identidad final cerrada y anexos trimestrales faltantes
...
## Clave V165 · remisión parlamentaria y archivo
...
## Clave V165 · inventario público y nota de archivo
