# Lista de presentación y seguimiento · V158
...
## Control V158 previo a cualquier autorización
...
## Control V158 · doble prioridad y consulta reproducible
...
## Control V158 · consultas nombradas
...
## Control V158 · repositorio CUT histórico
...
## Control V158 · código, cuenta 230 y conciliación
...
## Control V158 · reportes SLU y C55 contemporáneos
...
## Control V158 · tablas SLU y recuperación histórica
...
## Control V158 · SICHE, backups y migración SLU
...
## Control V158 · ruta SIGADE/SIDIF-Link/SICHE
...
## Control V158 · rectificación de precisión y rama Anexo K

- Mantener los seis pedidos en `DRAFT_NOT_SENT` hasta autorización expresa.
- No llamar error aritmético al 0,45 sin componentes fuente no redondeados.
- Adjuntar fila Anexo K, escalera oficial AGN, tabla de estados y objetos V158.
...
## Control V158 · vía especial y custodia
...
## Control V158 · dos cortes, dos fechas y dos custodias
...
## Control V158 · tercera rama sin anticipar el tipo
...
## Control V158 · búsqueda dual y tres fuentes
...
## Control previo V158 · SIGEN y legado
...
## Control previo V158 · constancias SISIO y doble ruta
...
## Control previo V158 · plan, supervisión y archivo
...
## Control previo V158 · cadena preliminar-final, reforma y conteos
