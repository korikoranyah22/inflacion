# Solicitud a la Auditoría General de la Nación · V173
...
Como hoja identificadora puede adjuntarse `E0_AGN_BODEN_REQUEST_PUBLIC_SCHEMA_V173.csv`, que contiene sólo UUID, nid, vid, fechas y metadatos públicos; no incluye datos personales del solicitante original.
...
## Clave V173 · proyecto 48 0237/09 y actuación final
...
## Clave V173 · identidad final cerrada y anexos trimestrales faltantes
...
## Clave V173 · remisión parlamentaria y archivo
...
## Clave V173 · inventario público y nota de archivo
