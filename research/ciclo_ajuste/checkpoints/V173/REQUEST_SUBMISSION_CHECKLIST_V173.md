# Lista de presentación y seguimiento · V173
...
## Control V173 previo a cualquier autorización
...
## Control V173 · doble prioridad y consulta reproducible
...
## Control V173 · consultas nombradas
...
## Control V173 · repositorio CUT histórico
...
## Control V173 · código, cuenta 230 y conciliación
...
## Control V173 · reportes SLU y C55 contemporáneos
...
## Control V173 · tablas SLU y recuperación histórica
...
## Control V173 · SICHE, backups y migración SLU
...
## Control V173 · ruta SIGADE/SIDIF-Link/SICHE
...
## Control V173 · rectificación de precisión y rama Anexo K

- Mantener los seis pedidos en `DRAFT_NOT_SENT` hasta autorización expresa.
- No llamar error aritmético al 0,45 sin componentes fuente no redondeados.
- Adjuntar fila Anexo K, escalera oficial AGN, tabla de estados y objetos V173.
...
## Control V173 · vía especial y custodia
...
## Control V173 · dos cortes, dos fechas y dos custodias
...
## Control V173 · tercera rama sin anticipar el tipo
...
## Control V173 · búsqueda dual y tres fuentes
...
## Control previo V173 · SIGEN y legado
...
## Control previo V173 · constancias SISIO y doble ruta
...
## Control previo V173 · plan, supervisión y archivo
...
## Control previo V173 · cadena preliminar-final, reforma y conteos
...
## Control previo V173 · siglas, denominadores, lifecycle y no transposición SAF355
...
## Control previo V173 · glosario oficial, multi-entidad y puente jurídico
