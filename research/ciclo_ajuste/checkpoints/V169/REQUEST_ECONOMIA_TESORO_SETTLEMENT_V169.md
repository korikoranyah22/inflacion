# Solicitud al Ministerio de Economía / Tesoro · V169
...
- tabla de cuatro rondas: `E0_FISCAL_PUBLIC_BUYBACK_CALLS_2008_V169.csv`;
- resumen del strip: `E0_FISCAL_STRIP_BUYBACK_SUMMARY_2009_V169.csv`;
- cadena normativa: `E0_FISCAL_BUYBACK_SETTLEMENT_CHAIN_V169.csv`.
- matriz de comunicaciones directas: `E0_CAJA_TARGET_COMMUNICATION_MATRIX_V169.csv`;
- hoja de claves técnicas: sólo las filas `REQ133_ECON` de `E0_REQUEST_SEARCH_KEY_MATRIX_V169.csv`.



- puente contable trimestral: `E0_FISCAL_BUYBACK_DEBT_ACCOUNTING_BRIDGE_2008_V169.csv`.

## Clave adicional V169 · Discount en Pesos
...
## Clave V169 · expediente productor y submayores SIGADE/SIDIF
...
## Clave V169 · productor, sistemas y formato de salida demostrados
...
## Clave V169 · ruta COMDOC y comparadores contiguos
...
## Clave V169 · salida FindDoc y cadena C-41
...
## Clave V169 · AGAN/AMIDDF, sistema productor y pago parcial
...
## Clave V169 · productor exacto, índice AMIDDF y bifurcación de comisiones
...
## Clave V169 · exportación SICHE y test condicional C-55 por débito directo
...
## Clave V169 · capacidad SICHE demostrada y doble prioridad C-41/C-55
...
## Clave V169 · consultas SICHE nombradas y runbook exacto
...
## Clave V169 · repositorio histórico CUT 2007-2014
...
## Clave V169 · cuenta 230, códigos automáticos y conciliación
...
## Clave contemporánea V169 · SLU 2001-2005 y prueba de rama
...
## Clave V169 · tablas exactas, ausencia de historia y recuperación forense
...
## Clave V169 · SICHE, retención perpetua y migración
...
## Rectificación y ampliación V169 · Anexo K, mayorizado y respaldo bancario
...
## Rectificación V169 · excepción SAF 355 y ruta TGN/CGN/BNA
...
## Ampliación V169 · cierre 2008, archivo oficial y custodios nominados
...
## Ampliación V169 · universo C-41/C-42/C-55 y cadena completa
...
## Ampliación V169 · doble repositorio SIDIF, TRANSAF y certificación UAI
...
## V169 · objetos exactos de certificación y cierre
...
## V169 · notas exactas, SISIO y registro interno pre-GDE
...
## V169 · deber exacto del período, SISIO y papeles UAI
