# Solicitud a la Auditoría General de la Nación · V169
...
Como hoja identificadora puede adjuntarse `E0_AGN_BODEN_REQUEST_PUBLIC_SCHEMA_V169.csv`, que contiene sólo UUID, nid, vid, fechas y metadatos públicos; no incluye datos personales del solicitante original.
...
## Clave V169 · proyecto 48 0237/09 y actuación final
...
## Clave V169 · identidad final cerrada y anexos trimestrales faltantes
...
## Clave V169 · remisión parlamentaria y archivo
...
## Clave V169 · inventario público y nota de archivo
