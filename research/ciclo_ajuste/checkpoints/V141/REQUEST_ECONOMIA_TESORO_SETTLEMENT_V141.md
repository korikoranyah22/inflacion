# Solicitud al Ministerio de Economía / Tesoro · V141
...
- tabla de cuatro rondas: `E0_FISCAL_PUBLIC_BUYBACK_CALLS_2008_V141.csv`;
- resumen del strip: `E0_FISCAL_STRIP_BUYBACK_SUMMARY_2009_V141.csv`;
- cadena normativa: `E0_FISCAL_BUYBACK_SETTLEMENT_CHAIN_V141.csv`.
- matriz de comunicaciones directas: `E0_CAJA_TARGET_COMMUNICATION_MATRIX_V141.csv`;
- hoja de claves técnicas: sólo las filas `REQ133_ECON` de `E0_REQUEST_SEARCH_KEY_MATRIX_V141.csv`.



- puente contable trimestral: `E0_FISCAL_BUYBACK_DEBT_ACCOUNTING_BRIDGE_2008_V141.csv`.

## Clave adicional V141 · Discount en Pesos
...
## Clave V141 · expediente productor y submayores SIGADE/SIDIF
...
## Clave V141 · productor, sistemas y formato de salida demostrados
...
## Clave V141 · ruta COMDOC y comparadores contiguos
...
## Clave V141 · salida FindDoc y cadena C-41
...
## Clave V141 · AGAN/AMIDDF, sistema productor y pago parcial
...
## Clave V141 · productor exacto, índice AMIDDF y bifurcación de comisiones
...
## Clave V141 · exportación SICHE y test condicional C-55 por débito directo
...
## Clave V141 · capacidad SICHE demostrada y doble prioridad C-41/C-55
...
## Clave V141 · consultas SICHE nombradas y runbook exacto
...
## Clave V141 · repositorio histórico CUT 2007-2014
