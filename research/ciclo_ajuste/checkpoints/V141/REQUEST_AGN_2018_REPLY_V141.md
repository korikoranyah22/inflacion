# Solicitud a la Auditoría General de la Nación · V141
...
Como hoja identificadora puede adjuntarse `E0_AGN_BODEN_REQUEST_PUBLIC_SCHEMA_V141.csv`, que contiene sólo UUID, nid, vid, fechas y metadatos públicos; no incluye datos personales del solicitante original.
...
## Clave V141 · proyecto 48 0237/09 y actuación final
...
## Clave V141 · identidad final cerrada y anexos trimestrales faltantes
...
## Clave V141 · remisión parlamentaria y archivo
...
## Clave V141 · inventario público y nota de archivo
