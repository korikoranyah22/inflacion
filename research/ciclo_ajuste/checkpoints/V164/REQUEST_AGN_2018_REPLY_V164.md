# Solicitud a la Auditoría General de la Nación · V164
...
Como hoja identificadora puede adjuntarse `E0_AGN_BODEN_REQUEST_PUBLIC_SCHEMA_V164.csv`, que contiene sólo UUID, nid, vid, fechas y metadatos públicos; no incluye datos personales del solicitante original.
...
## Clave V164 · proyecto 48 0237/09 y actuación final
...
## Clave V164 · identidad final cerrada y anexos trimestrales faltantes
...
## Clave V164 · remisión parlamentaria y archivo
...
## Clave V164 · inventario público y nota de archivo
