# Solicitud al Ministerio de Economía / Tesoro · V150
...
- tabla de cuatro rondas: `E0_FISCAL_PUBLIC_BUYBACK_CALLS_2008_V150.csv`;
- resumen del strip: `E0_FISCAL_STRIP_BUYBACK_SUMMARY_2009_V150.csv`;
- cadena normativa: `E0_FISCAL_BUYBACK_SETTLEMENT_CHAIN_V150.csv`.
- matriz de comunicaciones directas: `E0_CAJA_TARGET_COMMUNICATION_MATRIX_V150.csv`;
- hoja de claves técnicas: sólo las filas `REQ133_ECON` de `E0_REQUEST_SEARCH_KEY_MATRIX_V150.csv`.



- puente contable trimestral: `E0_FISCAL_BUYBACK_DEBT_ACCOUNTING_BRIDGE_2008_V150.csv`.

## Clave adicional V150 · Discount en Pesos
...
## Clave V150 · expediente productor y submayores SIGADE/SIDIF
...
## Clave V150 · productor, sistemas y formato de salida demostrados
...
## Clave V150 · ruta COMDOC y comparadores contiguos
...
## Clave V150 · salida FindDoc y cadena C-41
...
## Clave V150 · AGAN/AMIDDF, sistema productor y pago parcial
...
## Clave V150 · productor exacto, índice AMIDDF y bifurcación de comisiones
...
## Clave V150 · exportación SICHE y test condicional C-55 por débito directo
...
## Clave V150 · capacidad SICHE demostrada y doble prioridad C-41/C-55
...
## Clave V150 · consultas SICHE nombradas y runbook exacto
...
## Clave V150 · repositorio histórico CUT 2007-2014
...
## Clave V150 · cuenta 230, códigos automáticos y conciliación
...
## Clave contemporánea V150 · SLU 2001-2005 y prueba de rama
...
## Clave V150 · tablas exactas, ausencia de historia y recuperación forense
...
## Clave V150 · SICHE, retención perpetua y migración
...
## Clave V150 · SIGADE, SIDIF-Link, SIDIF Central y SICHE

Estado: **BORRADOR_NO_ENVIADO**. Este texto no registra ni autoriza presentación.

Para el período 2008, la evidencia institucional ubica el circuito relevante en `SIGADE → SIDIF-Link → SIDIF Central`, hoy recuperable mediante SICHE. Se solicitan los registros y metadatos enumerados en `E0_SIDIF_LINK_SICHE_REQUEST_OBJECTS_V150.csv`: submayor/eventos SIGADE; lotes SIDIF-Link; formularios por partida y SIGADE; gastos por beneficiario; deuda exigible hasta 2008; detalle de asientos 2001-2012; extractos, saldos, logs y conciliación CUT; orden/expediente SAF 355; y la tabla de enlace entre ID SIGADE, formulario, cuenta, orden y movimiento bancario.
...
## Rectificación y ampliación V150 · Anexo K, mayorizado y respaldo bancario
...
## Rectificación V150 · excepción SAF 355 y ruta TGN/CGN/BNA
...
## Ampliación V150 · cierre 2008, archivo oficial y custodios nominados
...
## Ampliación V150 · universo C-41/C-42/C-55 y cadena completa
