# Lista de presentación y seguimiento · V150
...
## Control V150 previo a cualquier autorización
...
## Control V150 · doble prioridad y consulta reproducible
...
## Control V150 · consultas nombradas
...
## Control V150 · repositorio CUT histórico
...
## Control V150 · código, cuenta 230 y conciliación
...
## Control V150 · reportes SLU y C55 contemporáneos
...
## Control V150 · tablas SLU y recuperación histórica
...
## Control V150 · SICHE, backups y migración SLU
...
## Control V150 · ruta SIGADE/SIDIF-Link/SICHE
...
## Control V150 · rectificación de precisión y rama Anexo K

- Mantener los seis pedidos en `DRAFT_NOT_SENT` hasta autorización expresa.
- No llamar error aritmético al 0,45 sin componentes fuente no redondeados.
- Adjuntar fila Anexo K, escalera oficial AGN, tabla de estados y objetos V150.
...
## Control V150 · vía especial y custodia
...
## Control V150 · dos cortes, dos fechas y dos custodias
...
## Control V150 · tercera rama sin anticipar el tipo
