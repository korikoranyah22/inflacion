# Solicitud a la Auditoría General de la Nación · V161
...
Como hoja identificadora puede adjuntarse `E0_AGN_BODEN_REQUEST_PUBLIC_SCHEMA_V161.csv`, que contiene sólo UUID, nid, vid, fechas y metadatos públicos; no incluye datos personales del solicitante original.
...
## Clave V161 · proyecto 48 0237/09 y actuación final
...
## Clave V161 · identidad final cerrada y anexos trimestrales faltantes
...
## Clave V161 · remisión parlamentaria y archivo
...
## Clave V161 · inventario público y nota de archivo
