# Solicitud a la Auditoría General de la Nación · V155
...
Como hoja identificadora puede adjuntarse `E0_AGN_BODEN_REQUEST_PUBLIC_SCHEMA_V155.csv`, que contiene sólo UUID, nid, vid, fechas y metadatos públicos; no incluye datos personales del solicitante original.
...
## Clave V155 · proyecto 48 0237/09 y actuación final
...
## Clave V155 · identidad final cerrada y anexos trimestrales faltantes
...
## Clave V155 · remisión parlamentaria y archivo
...
## Clave V155 · inventario público y nota de archivo
