# Lista de presentación y seguimiento · V155
...
## Control V155 previo a cualquier autorización
...
## Control V155 · doble prioridad y consulta reproducible
...
## Control V155 · consultas nombradas
...
## Control V155 · repositorio CUT histórico
...
## Control V155 · código, cuenta 230 y conciliación
...
## Control V155 · reportes SLU y C55 contemporáneos
...
## Control V155 · tablas SLU y recuperación histórica
...
## Control V155 · SICHE, backups y migración SLU
...
## Control V155 · ruta SIGADE/SIDIF-Link/SICHE
...
## Control V155 · rectificación de precisión y rama Anexo K

- Mantener los seis pedidos en `DRAFT_NOT_SENT` hasta autorización expresa.
- No llamar error aritmético al 0,45 sin componentes fuente no redondeados.
- Adjuntar fila Anexo K, escalera oficial AGN, tabla de estados y objetos V155.
...
## Control V155 · vía especial y custodia
...
## Control V155 · dos cortes, dos fechas y dos custodias
...
## Control V155 · tercera rama sin anticipar el tipo
...
## Control V155 · búsqueda dual y tres fuentes
...
## Control previo V155 · SIGEN y legado
