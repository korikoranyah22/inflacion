# Paquete institucional E0 con claves de sistema · V120
...
V120 agrega claves técnicas contemporáneas: DADP/Unidad de Registro, COMDOC III, SIGADE, TSA/VPN Tesoro-Caja; archivos CRyL CG1-CG7; formularios 4359 DVP/FTC/FT e informes por cuenta y especie. Se usan como hipótesis de búsqueda, no como prueba de que las recompras hayan seguido cada procedimiento ni de que exista una fila liquidada.

## Borradores incluidos

1. `REQUEST_ECONOMIA_TESORO_SETTLEMENT_V120.md`: expedientes, constancias Caja y conciliaciones del Tesoro para cuatro rondas 2008 y el strip 2009.
2. `REQUEST_BCRA_CRYL_SETTLEMENT_V120.md`: registros CRyL y constancias de pago/liquidación en el BCRA, con alternativa disociada o agregada.
3. `REQUEST_BNA_FIRST_STAGE_BLOTTER_V120.md`: instrucciones, órdenes, blotter, ejecuciones y conciliaciones del mandato 11–22/08/2008.
4. `REQUEST_AGN_2018_REPLY_V120.md`: respuesta individual del 11/09/2018 e identificadores de los informes BODEN citados.
5. `REQUEST_CNV_CUSTODY_RECORDS_V120.md`: pedido AGN/Caja de 2014, actuaciones supervisoras y registros custodiales disponibles.
6. `REQUEST_CAJA_SETTLEMENT_HOLDINGS_V120.md`: consulta institucional voluntaria por la cuenta 0306/40000 y constancias o agregados no personales.
...
- `E0_DOCUMENT_SYSTEM_TEMPORAL_MAP_V120.csv`: impide pedir identificadores electrónicos anacrónicos.
- `E0_ARCHIVAL_RETENTION_AUTHORITY_MATRIX_V120.csv`: separa reglas vigentes, alcance y deducciones prohibidas.
- `E0_NEGATIVE_RESPONSE_ADEQUACY_V120.csv`: fija catorce requisitos para evaluar una respuesta de inexistencia.

## Controles operacionales añadidos

- `E0_RECORD_PRODUCER_SYSTEM_MAP_V120.csv`: vincula 18 productores, sistemas y clases de registro con fuente y cautela.
- `E0_REQUEST_SEARCH_KEY_MATRIX_V120.csv`: reúne 35 claves exactas por organismo.
- `E0_REQUEST_ATTACHMENT_MINIMUM_V120.csv`: limita los adjuntos a siete filas justificadas y excluye material innecesario.
...
No marcar ninguna brecha como cerrada por el solo envío. La matriz `E0_REQUEST_CLOSURE_CRITERIA_V120.csv` exige contenido documental o una respuesta formal que supere los controles de `E0_NEGATIVE_RESPONSE_ADEQUACY_V120.csv`.
