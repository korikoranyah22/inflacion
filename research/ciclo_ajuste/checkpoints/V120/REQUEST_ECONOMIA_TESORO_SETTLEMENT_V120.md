# Solicitud al Ministerio de Economía / Tesoro · V120
...
La Resolución Conjunta 216/2008 y 26/2008 documenta que, para un procedimiento contemporáneo distinto —colocaciones BOCON—, esas áreas utilizaban COMDOC III, SIGADE y un canal TSA/VPN con Caja. No afirmo que las recompras hayan usado automáticamente ese circuito: solicito que se verifique su aplicabilidad y, si no corresponde, se identifique el sistema equivalente que sí las registró.
...
- tabla de cuatro rondas: `E0_FISCAL_PUBLIC_BUYBACK_CALLS_2008_V120.csv`;
- resumen del strip: `E0_FISCAL_STRIP_BUYBACK_SUMMARY_2009_V120.csv`;
- cadena normativa: `E0_FISCAL_BUYBACK_SETTLEMENT_CHAIN_V120.csv`.
- hoja de claves técnicas: sólo las filas `REQ120_ECON` de `E0_REQUEST_SEARCH_KEY_MATRIX_V120.csv`.
