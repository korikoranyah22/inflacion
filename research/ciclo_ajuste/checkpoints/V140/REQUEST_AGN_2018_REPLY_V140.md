# Solicitud a la Auditoría General de la Nación · V140
...
Como hoja identificadora puede adjuntarse `E0_AGN_BODEN_REQUEST_PUBLIC_SCHEMA_V140.csv`, que contiene sólo UUID, nid, vid, fechas y metadatos públicos; no incluye datos personales del solicitante original.
...
## Clave V140 · proyecto 48 0237/09 y actuación final
...
## Clave V140 · identidad final cerrada y anexos trimestrales faltantes
...
## Clave V140 · remisión parlamentaria y archivo
...
## Clave V140 · inventario público y nota de archivo
