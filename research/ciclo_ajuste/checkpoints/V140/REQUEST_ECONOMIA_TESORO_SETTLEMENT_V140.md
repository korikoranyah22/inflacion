# Solicitud al Ministerio de Economía / Tesoro · V140
...
- tabla de cuatro rondas: `E0_FISCAL_PUBLIC_BUYBACK_CALLS_2008_V140.csv`;
- resumen del strip: `E0_FISCAL_STRIP_BUYBACK_SUMMARY_2009_V140.csv`;
- cadena normativa: `E0_FISCAL_BUYBACK_SETTLEMENT_CHAIN_V140.csv`.
- matriz de comunicaciones directas: `E0_CAJA_TARGET_COMMUNICATION_MATRIX_V140.csv`;
- hoja de claves técnicas: sólo las filas `REQ133_ECON` de `E0_REQUEST_SEARCH_KEY_MATRIX_V140.csv`.



- puente contable trimestral: `E0_FISCAL_BUYBACK_DEBT_ACCOUNTING_BRIDGE_2008_V140.csv`.

## Clave adicional V140 · Discount en Pesos
...
## Clave V140 · expediente productor y submayores SIGADE/SIDIF
...
## Clave V140 · productor, sistemas y formato de salida demostrados
...
## Clave V140 · ruta COMDOC y comparadores contiguos
...
## Clave V140 · salida FindDoc y cadena C-41
...
## Clave V140 · AGAN/AMIDDF, sistema productor y pago parcial
...
## Clave V140 · productor exacto, índice AMIDDF y bifurcación de comisiones
...
## Clave V140 · exportación SICHE y test condicional C-55 por débito directo
...
## Clave V140 · capacidad SICHE demostrada y doble prioridad C-41/C-55
...
## Clave V140 · consultas SICHE nombradas y runbook exacto
