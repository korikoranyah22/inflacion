# Solicitud al Ministerio de Economía / Tesoro · V142
...
- tabla de cuatro rondas: `E0_FISCAL_PUBLIC_BUYBACK_CALLS_2008_V142.csv`;
- resumen del strip: `E0_FISCAL_STRIP_BUYBACK_SUMMARY_2009_V142.csv`;
- cadena normativa: `E0_FISCAL_BUYBACK_SETTLEMENT_CHAIN_V142.csv`.
- matriz de comunicaciones directas: `E0_CAJA_TARGET_COMMUNICATION_MATRIX_V142.csv`;
- hoja de claves técnicas: sólo las filas `REQ133_ECON` de `E0_REQUEST_SEARCH_KEY_MATRIX_V142.csv`.



- puente contable trimestral: `E0_FISCAL_BUYBACK_DEBT_ACCOUNTING_BRIDGE_2008_V142.csv`.

## Clave adicional V142 · Discount en Pesos
...
## Clave V142 · expediente productor y submayores SIGADE/SIDIF
...
## Clave V142 · productor, sistemas y formato de salida demostrados
...
## Clave V142 · ruta COMDOC y comparadores contiguos
...
## Clave V142 · salida FindDoc y cadena C-41
...
## Clave V142 · AGAN/AMIDDF, sistema productor y pago parcial
...
## Clave V142 · productor exacto, índice AMIDDF y bifurcación de comisiones
...
## Clave V142 · exportación SICHE y test condicional C-55 por débito directo
...
## Clave V142 · capacidad SICHE demostrada y doble prioridad C-41/C-55
...
## Clave V142 · consultas SICHE nombradas y runbook exacto
...
## Clave V142 · repositorio histórico CUT 2007-2014
...
## Clave V142 · cuenta 230, códigos automáticos y conciliación
