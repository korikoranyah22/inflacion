# Solicitud a la Auditoría General de la Nación · V142
...
Como hoja identificadora puede adjuntarse `E0_AGN_BODEN_REQUEST_PUBLIC_SCHEMA_V142.csv`, que contiene sólo UUID, nid, vid, fechas y metadatos públicos; no incluye datos personales del solicitante original.
...
## Clave V142 · proyecto 48 0237/09 y actuación final
...
## Clave V142 · identidad final cerrada y anexos trimestrales faltantes
...
## Clave V142 · remisión parlamentaria y archivo
...
## Clave V142 · inventario público y nota de archivo
