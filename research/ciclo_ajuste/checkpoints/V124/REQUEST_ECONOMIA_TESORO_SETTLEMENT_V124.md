# Solicitud al Ministerio de Economía / Tesoro · V124
...
- tabla de cuatro rondas: `E0_FISCAL_PUBLIC_BUYBACK_CALLS_2008_V124.csv`;
- resumen del strip: `E0_FISCAL_STRIP_BUYBACK_SUMMARY_2009_V124.csv`;
- cadena normativa: `E0_FISCAL_BUYBACK_SETTLEMENT_CHAIN_V124.csv`.
- hoja de claves técnicas: sólo las filas `REQ124_ECON` de `E0_REQUEST_SEARCH_KEY_MATRIX_V124.csv`.
