# Lista de presentación y seguimiento · V124
...
- aplicar `E0_REQUEST_ATTACHMENT_MINIMUM_V124.csv` y filtrar por organismo cuando corresponda;
...
- comparar cada archivo recibido con `E0_INFORMATION_REQUEST_TRACEABILITY_V124.csv`.
- comprobar que una búsqueda de actuaciones 2008–2009 no haya sido limitada a GDE;
- comprobar si la respuesta buscó las claves del organismo en `E0_REQUEST_SEARCH_KEY_MATRIX_V124.csv` o identificó equivalencias técnicas;
- evaluar toda inexistencia contra los catorce controles de `E0_NEGATIVE_RESPONSE_ADEQUACY_V124.csv`.
...
- usar 5426, 5427, 45698, 45701 y 5326 como Códigos Caja contemporáneos, sin convertirlos en códigos CRyL o asientos liquidados sin puente adicional;
- mantener ARARGE03G415–5326 separado de ARARGE034678–5426;
- no tomar la impresión SLIQ de marzo de 2000, la publicación institucional de 2004 ni la práctica de Recepción Diferida documentada en 2009 como prueba de la revisión efectiva en 2008;
- no trasladar el control de revisiones del manual paralelo MU-32002 a SLIQ sin un puente documental específico;
...
- aplicar los criterios de `E0_REQUEST_CLOSURE_CRITERIA_V124.csv` antes de cambiar el estado de una brecha.
