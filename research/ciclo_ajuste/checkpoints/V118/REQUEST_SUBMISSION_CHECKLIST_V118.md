# Lista de presentación y seguimiento · V118
...
- comparar cada archivo recibido con `E0_INFORMATION_REQUEST_TRACEABILITY_V118.csv`.
...
- aplicar los criterios de `E0_REQUEST_CLOSURE_CRITERIA_V118.csv` antes de cambiar el estado de una brecha.
