...
Los textos piden documentos en el estado en que obren. No exigen crear análisis nuevos. Cuando un documento contenga información exceptuada, se solicita copia parcial con tachas o disociación. Cuando no exista, se pide una respuesta fundada que identifique el alcance de la búsqueda, las áreas consultadas y, si corresponde, la remisión, transferencia, expurgo o política de conservación aplicable.

## Borradores incluidos

1. `REQUEST_ECONOMIA_TESORO_SETTLEMENT_V118.md`: expedientes, constancias Caja y conciliaciones del Tesoro para cuatro rondas 2008 y el strip 2009.
2. `REQUEST_BCRA_CRYL_SETTLEMENT_V118.md`: registros CRyL y constancias de pago/liquidación en el BCRA, con alternativa disociada o agregada.
3. `REQUEST_BNA_FIRST_STAGE_BLOTTER_V118.md`: instrucciones, órdenes, blotter, ejecuciones y conciliaciones del mandato 11–22/08/2008.
4. `REQUEST_AGN_2018_REPLY_V118.md`: respuesta individual del 11/09/2018 e identificadores de los informes BODEN citados.
5. `REQUEST_CNV_CUSTODY_RECORDS_V118.md`: pedido AGN/Caja de 2014, actuaciones supervisoras y registros custodiales disponibles.
6. `REQUEST_CAJA_SETTLEMENT_HOLDINGS_V118.md`: consulta institucional voluntaria por la cuenta 0306/40000 y constancias o agregados no personales.
...
No marcar ninguna brecha como cerrada por el solo envío. La matriz `E0_REQUEST_CLOSURE_CRITERIA_V118.csv` exige contenido documental o una respuesta formal suficientemente específica.
