# Solicitud al Ministerio de Economía / Tesoro · V134
...
- tabla de cuatro rondas: `E0_FISCAL_PUBLIC_BUYBACK_CALLS_2008_V134.csv`;
- resumen del strip: `E0_FISCAL_STRIP_BUYBACK_SUMMARY_2009_V134.csv`;
- cadena normativa: `E0_FISCAL_BUYBACK_SETTLEMENT_CHAIN_V134.csv`.
- matriz de comunicaciones directas: `E0_CAJA_TARGET_COMMUNICATION_MATRIX_V134.csv`;
- hoja de claves técnicas: sólo las filas `REQ133_ECON` de `E0_REQUEST_SEARCH_KEY_MATRIX_V134.csv`.



- puente contable trimestral: `E0_FISCAL_BUYBACK_DEBT_ACCOUNTING_BRIDGE_2008_V134.csv`.

## Clave adicional V134 · Discount en Pesos
...
## Clave V134 · expediente productor y submayores SIGADE/SIDIF
...
## Clave V134 · productor, sistemas y formato de salida demostrados
...
## Clave V134 · ruta COMDOC y comparadores contiguos
