...
- Economía / Tesoro: `REQUEST_ECONOMIA_TESORO_SETTLEMENT_V134.md`
- BCRA / CRyL: `REQUEST_BCRA_CRYL_SETTLEMENT_V134.md`
- Banco Nación: `REQUEST_BNA_FIRST_STAGE_BLOTTER_V134.md`
- AGN: `REQUEST_AGN_2018_REPLY_V134.md`
- CNV: `REQUEST_CNV_CUSTODY_RECORDS_V134.md`
- Caja de Valores: `REQUEST_CAJA_SETTLEMENT_HOLDINGS_V134.md`

## Adjuntos mínimos

- `E0_CAJA_TARGET_COMMUNICATION_MATRIX_V134.csv`
- `E0_INFORMATION_REQUEST_TRACEABILITY_V134.csv`
- `E0_REQUEST_SEARCH_KEY_MATRIX_V134.csv`
- `E0_REQUEST_ATTACHMENT_MINIMUM_V134.csv`
- `E0_REQUEST_CLOSURE_CRITERIA_V134.csv`
- `E0_CAJA_CRYL_SETTLEMENT_STAGE_MATRIX_V134.csv`
- `E0_DEFERRED_MODALITY_EQUIVALENCE_AUDIT_V134.csv`
...
## Clave V134 · GDP Units y cancelación contractual
