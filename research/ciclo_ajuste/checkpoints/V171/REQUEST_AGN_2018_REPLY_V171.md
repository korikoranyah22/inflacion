# Solicitud a la Auditoría General de la Nación · V171
...
Como hoja identificadora puede adjuntarse `E0_AGN_BODEN_REQUEST_PUBLIC_SCHEMA_V171.csv`, que contiene sólo UUID, nid, vid, fechas y metadatos públicos; no incluye datos personales del solicitante original.
...
## Clave V171 · proyecto 48 0237/09 y actuación final
...
## Clave V171 · identidad final cerrada y anexos trimestrales faltantes
...
## Clave V171 · remisión parlamentaria y archivo
...
## Clave V171 · inventario público y nota de archivo
