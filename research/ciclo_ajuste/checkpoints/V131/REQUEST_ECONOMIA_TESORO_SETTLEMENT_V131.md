# Solicitud al Ministerio de Economía / Tesoro · V131
...
- tabla de cuatro rondas: `E0_FISCAL_PUBLIC_BUYBACK_CALLS_2008_V131.csv`;
- resumen del strip: `E0_FISCAL_STRIP_BUYBACK_SUMMARY_2009_V131.csv`;
- cadena normativa: `E0_FISCAL_BUYBACK_SETTLEMENT_CHAIN_V131.csv`.
- matriz de comunicaciones directas: `E0_CAJA_TARGET_COMMUNICATION_MATRIX_V131.csv`;
- hoja de claves técnicas: sólo las filas `REQ131_ECON` de `E0_REQUEST_SEARCH_KEY_MATRIX_V131.csv`.



- puente contable trimestral: `E0_FISCAL_BUYBACK_DEBT_ACCOUNTING_BRIDGE_2008_V131.csv`.

## Clave adicional V131 · Discount en Pesos
