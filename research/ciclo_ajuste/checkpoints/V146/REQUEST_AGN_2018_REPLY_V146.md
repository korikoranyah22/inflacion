# Solicitud a la Auditoría General de la Nación · V146
...
Como hoja identificadora puede adjuntarse `E0_AGN_BODEN_REQUEST_PUBLIC_SCHEMA_V146.csv`, que contiene sólo UUID, nid, vid, fechas y metadatos públicos; no incluye datos personales del solicitante original.
...
## Clave V146 · proyecto 48 0237/09 y actuación final
...
## Clave V146 · identidad final cerrada y anexos trimestrales faltantes
...
## Clave V146 · remisión parlamentaria y archivo
...
## Clave V146 · inventario público y nota de archivo
