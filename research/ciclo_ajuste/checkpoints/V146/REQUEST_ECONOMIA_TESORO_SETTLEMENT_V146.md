# Solicitud al Ministerio de Economía / Tesoro · V146
...
- tabla de cuatro rondas: `E0_FISCAL_PUBLIC_BUYBACK_CALLS_2008_V146.csv`;
- resumen del strip: `E0_FISCAL_STRIP_BUYBACK_SUMMARY_2009_V146.csv`;
- cadena normativa: `E0_FISCAL_BUYBACK_SETTLEMENT_CHAIN_V146.csv`.
- matriz de comunicaciones directas: `E0_CAJA_TARGET_COMMUNICATION_MATRIX_V146.csv`;
- hoja de claves técnicas: sólo las filas `REQ133_ECON` de `E0_REQUEST_SEARCH_KEY_MATRIX_V146.csv`.



- puente contable trimestral: `E0_FISCAL_BUYBACK_DEBT_ACCOUNTING_BRIDGE_2008_V146.csv`.

## Clave adicional V146 · Discount en Pesos
...
## Clave V146 · expediente productor y submayores SIGADE/SIDIF
...
## Clave V146 · productor, sistemas y formato de salida demostrados
...
## Clave V146 · ruta COMDOC y comparadores contiguos
...
## Clave V146 · salida FindDoc y cadena C-41
...
## Clave V146 · AGAN/AMIDDF, sistema productor y pago parcial
...
## Clave V146 · productor exacto, índice AMIDDF y bifurcación de comisiones
...
## Clave V146 · exportación SICHE y test condicional C-55 por débito directo
...
## Clave V146 · capacidad SICHE demostrada y doble prioridad C-41/C-55
...
## Clave V146 · consultas SICHE nombradas y runbook exacto
...
## Clave V146 · repositorio histórico CUT 2007-2014
...
## Clave V146 · cuenta 230, códigos automáticos y conciliación
...
## Clave contemporánea V146 · SLU 2001-2005 y prueba de rama
...
## Clave V146 · tablas exactas, ausencia de historia y recuperación forense
...
## Clave V146 · SICHE, retención perpetua y migración
...
## Clave V146 · SIGADE, SIDIF-Link, SIDIF Central y SICHE
