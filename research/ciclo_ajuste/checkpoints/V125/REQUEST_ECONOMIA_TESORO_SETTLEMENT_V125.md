# Solicitud al Ministerio de Economía / Tesoro · V125
...
- tabla de cuatro rondas: `E0_FISCAL_PUBLIC_BUYBACK_CALLS_2008_V125.csv`;
- resumen del strip: `E0_FISCAL_STRIP_BUYBACK_SUMMARY_2009_V125.csv`;
- cadena normativa: `E0_FISCAL_BUYBACK_SETTLEMENT_CHAIN_V125.csv`.
- matriz de comunicaciones directas: `E0_CAJA_TARGET_COMMUNICATION_MATRIX_V125.csv`;
- hoja de claves técnicas: sólo las filas `REQ125_ECON` de `E0_REQUEST_SEARCH_KEY_MATRIX_V125.csv`.
