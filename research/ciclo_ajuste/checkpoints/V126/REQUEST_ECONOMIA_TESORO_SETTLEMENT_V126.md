# Solicitud al Ministerio de Economía / Tesoro · V126
...
- tabla de cuatro rondas: `E0_FISCAL_PUBLIC_BUYBACK_CALLS_2008_V126.csv`;
- resumen del strip: `E0_FISCAL_STRIP_BUYBACK_SUMMARY_2009_V126.csv`;
- cadena normativa: `E0_FISCAL_BUYBACK_SETTLEMENT_CHAIN_V126.csv`.
- matriz de comunicaciones directas: `E0_CAJA_TARGET_COMMUNICATION_MATRIX_V126.csv`;
- hoja de claves técnicas: sólo las filas `REQ126_ECON` de `E0_REQUEST_SEARCH_KEY_MATRIX_V126.csv`.
