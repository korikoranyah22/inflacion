# Solicitud al Ministerio de Economía / Tesoro · V174
...
- tabla de cuatro rondas: `E0_FISCAL_PUBLIC_BUYBACK_CALLS_2008_V174.csv`;
- resumen del strip: `E0_FISCAL_STRIP_BUYBACK_SUMMARY_2009_V174.csv`;
- cadena normativa: `E0_FISCAL_BUYBACK_SETTLEMENT_CHAIN_V174.csv`.
- matriz de comunicaciones directas: `E0_CAJA_TARGET_COMMUNICATION_MATRIX_V174.csv`;
- hoja de claves técnicas: sólo las filas `REQ133_ECON` de `E0_REQUEST_SEARCH_KEY_MATRIX_V174.csv`.



- puente contable trimestral: `E0_FISCAL_BUYBACK_DEBT_ACCOUNTING_BRIDGE_2008_V174.csv`.

## Clave adicional V174 · Discount en Pesos
...
## Clave V174 · expediente productor y submayores SIGADE/SIDIF
...
## Clave V174 · productor, sistemas y formato de salida demostrados
...
## Clave V174 · ruta COMDOC y comparadores contiguos
...
## Clave V174 · salida FindDoc y cadena C-41
...
## Clave V174 · AGAN/AMIDDF, sistema productor y pago parcial
...
## Clave V174 · productor exacto, índice AMIDDF y bifurcación de comisiones
...
## Clave V174 · exportación SICHE y test condicional C-55 por débito directo
...
## Clave V174 · capacidad SICHE demostrada y doble prioridad C-41/C-55
...
## Clave V174 · consultas SICHE nombradas y runbook exacto
...
## Clave V174 · repositorio histórico CUT 2007-2014
...
## Clave V174 · cuenta 230, códigos automáticos y conciliación
...
## Clave contemporánea V174 · SLU 2001-2005 y prueba de rama
...
## Clave V174 · tablas exactas, ausencia de historia y recuperación forense
...
## Clave V174 · SICHE, retención perpetua y migración
...
## Rectificación y ampliación V174 · Anexo K, mayorizado y respaldo bancario
...
## Rectificación V174 · excepción SAF 355 y ruta TGN/CGN/BNA
...
## Ampliación V174 · cierre 2008, archivo oficial y custodios nominados
...
## Ampliación V174 · universo C-41/C-42/C-55 y cadena completa
...
## Ampliación V174 · doble repositorio SIDIF, TRANSAF y certificación UAI
...
## V174 · objetos exactos de certificación y cierre
...
## V174 · notas exactas, SISIO y registro interno pre-GDE
...
## V174 · deber exacto del período, SISIO y papeles UAI
...
## Adenda V174 · receptor contextual CGN y protocolo de búsqueda
...
## Adenda V174 · registro obligatorio CGN y corte temporal COMDOC
...
## Adenda V174 · Mesa SIGEN, metadatos CGN y custodia híbrida
...
## Adenda V174 · código NOT, CIDD, SPD y Archivo Digital
...
El ArchivoWeb público expone únicamente subtipos de informes; no ofrece `NOT`. Un cero allí no cierra la nota. Common Crawl no se reabrió porque el control V174 falló 2/2; cuarenta consultas siguen pendientes y los errores no son ausencia. Estado DRAFT_NOT_SENT; solicitudes 0; SAF355 0/5; ejecución 0/10.
