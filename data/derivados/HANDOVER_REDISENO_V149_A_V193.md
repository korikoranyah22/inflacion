...
## 53. NSE UCA · menor hueco bajo el eje · v191

- Se reduce levemente el margen inferior del gráfico de pobreza y estrés económico por NSE.
- En móvil pasa de 75 a 64 px; en escritorio, a 68 px.
- Esto acerca las etiquetas `Medio alto / medio bajo / bajo / muy bajo` a las cuatro tarjetas resumen sin cortar ni superponer los nombres.
- El mismo valor se replica en el relayout responsive.

Estado final de v191:

- `index.html`: 7.719.674 bytes.
- Snapshot: `data/dashboard_kawaii_191_nse_gap_inferior_reducido.html`.
- SHA-256 de ambos: `0526a52867bb68e7e514d5aa909d55b08a07373bb9dbaa75d39c592d8bd01fda`.
- Verificación visual: las cuatro etiquetas del eje siguen completas y el bloque de tarjetas queda más próximo al gráfico.

## 54. Ejecución de salud y educación · espaciado compacto · v192

- Se reduce el margen superior del gráfico “¿Quién lo ejecuta? · 2024”: de 100 a 90 px en móvil y de 80 a 72 px en escritorio.
- La leyenda baja de `1.12` a `1.08`, acercándose a las barras sin invadirlas.
- El margen inferior pasa de 62 a 52 px para aproximar la escala a las dos notas interpretativas.
- El relayout responsive replica los tres ajustes.

Estado final de v192:

- `index.html`: 7.719.700 bytes.
- Snapshot: `data/dashboard_kawaii_192_ejecucion_2024_espaciado_compacto.html`.
- SHA-256 de ambos: `78e726cdaa806bfd0fe5380998d254a1059fe452dc08b1fa8e8295661b12e4ce`.
- Verificación visual: leyenda, barras, etiquetas laterales, escala y notas permanecen legibles y sin superposición.

## 55. Consumo de carnes · rótulo metodológico fuera de los valores · v193

- El texto `Barras = años cerrados · rombos 2026 = PM12 a mayo` deja de extenderse hacia abajo dentro del área de datos.
- Su coordenada pasa de `0.985` a `1.015` y cambia el anclaje vertical de `top` a `bottom`.
- De este modo ocupa el carril entre la leyenda y el gráfico, sin superponerse con la línea de `Total carnes` ni con las etiquetas numéricas 2020–2026.
- El mismo ajuste se replica en el relayout responsive.

Estado final de v193:

- `index.html`: 7.719.708 bytes.
- Snapshot: `data/dashboard_kawaii_193_carnes_label_fuera_de_valores.html`.
- SHA-256 de ambos: `1569c18a72f9cef4444f9a518fe8e67e1216f663f16fde1d42978d53da085b9d`.
- Verificación visual: leyenda, rótulo metodológico, línea total y valores quedan en carriles independientes.
