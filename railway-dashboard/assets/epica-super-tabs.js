...
`;
  ...
  storyButton.insertAdjacentHTML('afterend', `
    ...
    <button class="tab-btn" type="button" data-tab="tab-epica-caputo-colchon">Auditor · dólares del colchón</button>
  `);
  ...
  <section id="tab-epica-caputo-colchon" class="tab-panel">
    <div class="epica-shell caputo">
      <header class="epica-hero">
        <div><span class="epica-eyebrow">◎ Super-tab C · auditor de incentivos</span><h2>Los dólares del colchón: ¿para quién conviene?</h2><p>La propuesta mezcla tres decisiones distintas: quién dispone de ahorro invertible, qué canal le conviene al dueño de los dólares y qué beneficio busca el Gobierno. Este tab las separa y obliga a cada afirmación a mostrar su evidencia.</p></div>
        <aside class="epica-status-card"><div><strong>La frase se audita como paráfrasis</strong><small>No localizamos esa redacción literal. Sí encontramos el argumento oficial equivalente: depósitos → crédito empresario → actividad y empleo.</small></div><div class="epica-status-row"><span class="epica-chip observed">argumento localizado</span><span class="epica-chip proxy">paráfrasis</span><span class="epica-chip open">estado mental no inferido</span></div></aside>
      </header>
      <section class="epica-quote-audit"><small>Frase propuesta para el análisis</small><blockquote>“Con estas nuevas medidas, los argentinos van a sacar los dólares del colchón para invertir”.</blockquote><p>Corrección ortográfica y comillas de trabajo; no se presenta como cita textual verificada de Luis Caputo.</p></section>
